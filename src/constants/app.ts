...
export const CACHE = {
  ...
  maxSize: { memory: 50 * 1024 * 1024, disk: 100 * 1024 * 1024 },
} as const;
export const TIMING = {
  debounce: { search: 300, input: 150, scroll: 100, resize: 200 },
  throttle: { scroll: 16, resize: 100, button: 500 },
} as const;
