...
export const FEATURE_DESCRIPTIONS: Record<string, string> = {
  ...
  [FEATURE_FLAGS.BASIC_REWARDS]: "Progress proof and session milestones",
  [FEATURE_FLAGS.XP_PROGRESSION]: "Progression depth and consistency tracking",
  ...
  [FEATURE_FLAGS.BASIC_SOLO_BOSS]: "Personal blocker patterns for momentum",
  [FEATURE_FLAGS.BASIC_CHALLENGES]: "Focus experiments and clean starts",
  ...
  [FEATURE_FLAGS.RANKINGS]: "Progress comparison (disabled)",
  ...
  [FEATURE_FLAGS.EMERGENCY_GEM_SINKS]: "Emergency purchases (disabled)",
