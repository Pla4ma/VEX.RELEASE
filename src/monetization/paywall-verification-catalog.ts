...
function validateProductPackage(pkg: PurchasesOffering['availablePackages'][number]): string[] {
  const issues: string[] = [];
...
function validateProductPricing(pkg: PurchasesOffering['availablePackages'][number]): string[] {
  const issues: string[] = [];
...
function validateProductMetadata(pkg: PurchasesOffering['availablePackages'][number]): string[] {
  const issues: string[] = [];
