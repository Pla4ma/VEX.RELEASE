...
export const PREDEFINED_EXPERIMENTS: Omit<Experiment, "id" | "startDate">[] = [
  ...
  },
  {
    ...
    controlVariant: {
      ...
      config: {
        headline: "Study 3x Faster",
        subtext: "Premium users complete 78% more plans",
      },
    },
    treatmentVariants: [
      {
        ...
        config: {
          headline: "Join 10,000+ Focus Masters",
          subtext: "The choice of serious students",
        },
      },
      {
        id: "fomo",
        ...
        config: {
          headline: "Do not Miss Your Streak",
          subtext: "Premium includes streak insurance",
        },
      },
    ],
...
function isUserEligible(
  ...
  if (
    ...
    !targeting.userSegments.includes(profile.segment)
  ) {
    return false;
  }
  return true;
