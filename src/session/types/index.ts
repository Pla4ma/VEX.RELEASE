...
/** Duration fields on SessionState: actualDuration=wall-clock total; effectiveDuration=net focus time; elapsedTime=raw time elapsed; effectiveTime=productive time minus distractions; totalDuration=planned session length */ export const SessionStateSchema =
  z.object({
    id: z.string().uuid(),
    userId: z.string(),
    ...
    antiCheatStatus: z
      .enum(["CLEAN", "WARNING", "FLAGGED", "FAILED", "INVALIDATED"])
      .default("CLEAN"),
