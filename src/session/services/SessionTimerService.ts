...
export class SessionTimerService {
  ...
  private tick(sessionId: string): void {
    ...
    const tickPayload = { sessionId, timestamp: now, deltaMs };
  ...
  calculateProgress(session: SessionState): {
    ...
    const percentage = TimeCalculator.calculateCompletionPercentage(
      elapsed,
      duration,
    );
...
export function getSessionTimerService(
