...
describe('BonusCalculator', () => {
  describe('calculateTimeBonus', () => {
    it('should award bonus for early completion', () => {
      const bonus = calculateTimeBonus({
        plannedDuration: 1500, actualDuration: 1400, completionPercentage: 100,
      });
    ...
    it('should not award bonus for late completion', () => {
      const bonus = calculateTimeBonus({
        plannedDuration: 1500, actualDuration: 1600, completionPercentage: 100,
      });
      expect(bonus).toBe(0);
    });
    ...
    it('should not award bonus for incomplete session', () => {
      const bonus = calculateTimeBonus({
        plannedDuration: 1500, actualDuration: 1000, completionPercentage: 66,
      });
      expect(bonus).toBe(0);
    });
    ...
    it('should cap time bonus at maximum', () => {
      const bonus = calculateTimeBonus({
        plannedDuration: 1500, actualDuration: 500, completionPercentage: 100,
      });
    ...
    it('should calculate proportional bonus for moderate early completion', () => {
      const bonus = calculateTimeBonus({
        plannedDuration: 1500, actualDuration: 1350, completionPercentage: 100,
      });
      expect(bonus).toBeGreaterThan(0);
  ...
  describe('calculateStreakBonus', () => {
    ...
    it('should increase bonus with longer streaks', () => {
      const smallStreak = calculateStreakBonus({ currentStreak: 3, basePoints: 100 });
      const largeStreak = calculateStreakBonus({ currentStreak: 30, basePoints: 100 });
      expect(largeStreak).toBeGreaterThan(smallStreak);
    });

    it('should cap streak bonus at maximum', () => {
      const bonus = calculateStreakBonus({ currentStreak: 365, basePoints: 1000 });
