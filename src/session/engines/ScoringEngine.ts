...
export class ScoringEngine {
  ...
  calculateScore(
    ...
    const streakMultiplier = BonusCalculator.getStreakMultiplier(
      this.userStreak,
    );
    ...
    debug.info(
      ...
      calculation.timeMultiplier.toFixed(2),
      calculation.streakMultiplier.toFixed(2),
      calculation.qualityMultiplier.toFixed(2),
      calculation.penaltyMultiplier.toFixed(2),
