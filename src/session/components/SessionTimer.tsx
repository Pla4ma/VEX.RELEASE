  ...
  return (
    <EnterAnimation direction="fade" delay={100}>
      ...
      >
        ...
        {/* Progress circle */}
        <View style={[styles.circle, { width: s.size, height: s.size, transform: [{ rotate: '-90deg' }] }]}>
          <View
            style={[
              styles.progressRing,
              {
                ...
                borderRadius: s.size / 2,
                borderWidth: s.strokeWidth,
                borderColor: isPaused ? theme.colors.warning.DEFAULT : theme.colors.success.DEFAULT,
        ...
        <View style={styles.timeContainer}>
          ...
          {isPaused && (
            <Text style={[styles.pausedText, { color: theme.colors.warning.DEFAULT }]}>
              PAUSED
            </Text>
          )}
        </View>
