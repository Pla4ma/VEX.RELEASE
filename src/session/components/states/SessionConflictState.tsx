        ...
        <Animated.View entering={FadeIn.duration(400)} style={styles.container}>
          ...
          <Box gap="md" mb="lg">
            ...
            <Animated.View entering={FadeInUp.delay(100)}>
              ...
              >
                ...
                <Box flexDirection="row" justifyContent="space-between" mb="xs">
                  ...
                  <Text variant="body" fontWeight="600">
                    {formatTime(localState.elapsedTime)}
                  </Text>
                </Box>
                ...
                <Box flexDirection="row" justifyContent="space-between">
                  ...
                  <Text variant="bodySmall">
                    {new Date(localState.timestamp).toLocaleTimeString()}
                  </Text>
                </Box>
            ...
            <Animated.View entering={FadeInUp.delay(200)}>
              ...
              >
                ...
                >
                  <Text variant="h4">
                    {remoteState.deviceName || "Other Device"}
                  </Text>
                  <View
                    style={[
                      styles.badge,
                ...
                <Box flexDirection="row" justifyContent="space-between" mb="xs">
                  ...
                  <Text variant="body" fontWeight="600">
                    {remoteState.progress.toFixed(1)}%
                  </Text>
                </Box>
                ...
                <Box flexDirection="row" justifyContent="space-between" mb="xs">
                  ...
                  <Text variant="body" fontWeight="600">
                    {formatTime(remoteState.elapsedTime)}
                  </Text>
                </Box>
                ...
                <Box flexDirection="row" justifyContent="space-between">
                  ...
                  <Text variant="bodySmall">
                    {new Date(remoteState.timestamp).toLocaleTimeString()}
                  </Text>
                </Box>

                <Button
                  variant={
                    selectedOption === "remote" ? "primary" : "secondary"
                  }
                  size="sm"
          ...
          <Box bg="background.tertiary" p="md" borderRadius="lg" mb="lg">
            ...
            <Text variant="body" textAlign="center">
              Time diff: {formatTime(timeDifference)} • Progress diff:{" "}
