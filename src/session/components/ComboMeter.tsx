...
const maxTierTextStyle = {
  textAlign: "center" as const,
  fontWeight: "700" as const,
};
const milestoneOverlayStyle = {
  position: "absolute" as const,
  top: 0,
  left: 0,
  right: 0,
...
const comboBrokenCardStyle = {
  padding: 20,
  borderRadius: 16,
  alignItems: "center" as const,
};
const comboBrokenEmojiStyle = { fontSize: 40, marginBottom: 8 };
const comboBrokenTextStyle = { color: launchColors.hex_fff, marginBottom: 4 };
const comboBrokenSubtextStyle = { color: launchColors.hex_fff, opacity: 0.8 };
