...
export enum SessionMode {
  DEEP_WORK = 'DEEP_WORK',
  CHALLENGE = 'CHALLENGE', // Alias for DEEP_WORK — deprecated, use DEEP_WORK
  LIGHT_FOCUS = 'LIGHT_FOCUS',
  FLOW = 'FLOW', // Alias for LIGHT_FOCUS — deprecated, use LIGHT_FOCUS
  STUDY = 'STUDY',
  CREATIVE = 'CREATIVE',
  SPRINT = 'SPRINT',
  RECOVERY = 'RECOVERY', // Alias for SPRINT — deprecated, use SPRINT
  STARTER = 'STARTER',
