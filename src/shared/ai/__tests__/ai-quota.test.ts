import { checkQuota, consumeQuota, getRemainingQuota } from '../ai-quota-service';
  ...
  describe('category-specific limits', () => {
    ...
    it('all categories have defined limits for free tier', () => {
      const categories: AIRequestCategory[] = [
        'coach_message', 'session_summary', 'comeback_prompt',
        'streak_nudge', 'weekly_reflection', 'content_study_generation',
        'quiz_generation',
      ];
