...
export function FocusCrystalAsset({
  ...
  return (
    ...
    >
      ...
      <Circle cx="48" cy="48" r="30" fill="#FFFFFF" opacity="0.28" />
      <G fill="none" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Path d="M38 42 48 30l10 12-10 24-10-24Z" stroke="#FFFFFF" strokeOpacity="0.82" strokeWidth="3" />
        <Path d="M30 31c9-10 24-14 37-4" stroke="#FFFFFF" strokeOpacity="0.86" strokeWidth="3" />
