...
import { Easing, useAnimatedStyle, useSharedValue, withRepeat, withSequence, withSpring, withTiming, type AnimatedStyle } from "react-native-reanimated";
...
export function useScaleInStyle(initialScale: number, spring = true): AnimatedStyle {
