...
const LoadingOverlay: React.FC<{ message?: string; theme: Theme }> = ({
  message,
  theme,
}) => (
  <View
...
const DisabledOverlay: React.FC<{ reason?: string; theme: Theme }> = ({
  reason,
  theme,
}) => (
  <View
...
const SelectedOverlay: React.FC<{ icon?: string; theme: Theme }> = ({
  icon = "check-circle",
  theme,
}) => (
  <View
