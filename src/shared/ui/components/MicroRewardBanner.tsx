/**
 * Micro Reward Banner Component
 * Small, tasteful reward indicators for micro-moments
 *
 * Features:
      ...
      style={[
        {
          ...
          borderWidth: 1,
          borderColor: `${displayColor}40`, // 25% opacity
      ...
      >
        ...
        <View
          style={{
            ...
            height: 40,
            borderRadius: 20,
            backgroundColor: `${displayColor}20`, // 12% opacity
            alignItems: 'center',
