...
export function WittyLoadingState({
  ...
  return (
    <Animated.View
      ...
      style={[{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 32 }, style]}
    >
...
export function BossLoadingState({ bossName }: { bossName?: string }): JSX.Element {
...
export function CoachLoadingState({ coachName }: { coachName?: string }): JSX.Element {
...
export function SquadLoadingState({ squadName }: { squadName?: string }): JSX.Element {
