/**
 * EngagedHomeContainer — STAGE: ENGAGED (3-9 completed sessions)
 * Allowed: companion, basic challenge if available, study/deep-work if relevant, coach next action
 */
...
export function useEngagedContainerModel(input: EngagedContainerInput): HomeViewModel & { controller: HomeController } {
  ...
  const controller: HomeController = {
    ...
    activeBossQuery: createStubQuery() as UseQueryResult, recommendationsQuery: recommendationsQuery as UseQueryResult,
