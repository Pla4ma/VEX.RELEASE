/**
 * ActivatingHomeContainer — STAGE: ACTIVATING (1-2 completed sessions)
 * Allowed: streak/progress/history, basic coach message, one next unlock preview, companion teaser
 */
...
export function useActivatingContainerModel(input: ActivatingContainerInput): HomeViewModel & { controller: HomeController } {
  ...
  const controller: HomeController = {
    ...
    openSetup: openSetup as (params?: Record<string, unknown>) => void, openProgress,
