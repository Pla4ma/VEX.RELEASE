...
export function makeIntervention(overrides: Partial<ActiveIntervention> = {}): ActiveIntervention {
  return {
    id: 'int-1',
    type: 'STREAK_RISK',
...
export function makeFeatures(overrides: Partial<Record<string, unknown>> = {}): FeatureAccessMap {
  return {
    ai_coach_advanced: {
      isUnlocked: true,
      isVisible: true,
