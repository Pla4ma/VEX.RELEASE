...
import { useInitialLane, type Lane, type LaneProfile, type ResolveInitialLaneInput } from '../../../features/lane-engine';
...
export function useHomeLaneProfile(input: {
  ...
  preferredSessionMode: ResolveInitialLaneInput['sessionMode'] | null | undefined;
  primaryGoal: string;
}): LaneProfile {
  ...
  }), [input.primaryGoal, input.motivationStyle, input.chosenLane, input.preferredSessionMode]);
