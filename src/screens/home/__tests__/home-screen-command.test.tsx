...
import { mockState, createCommandHomeData, resetCommandMocks } from './home-screen-command-helpers';

describe('HomeScreen command center', () => {
  beforeEach(() => { resetCommandMocks(); });
  ...
  it('renders loading and offline degraded states', () => {
    mockState.homeData = createCommandHomeData({ isLoading: true, isOnline: false });
