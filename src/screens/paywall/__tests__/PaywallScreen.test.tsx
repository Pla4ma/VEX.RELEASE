import {
  mockPurchase, mockRestore, mockRefresh, mockRetry, mockGoBack,
  mockedUsePaywall, mockedUsePremiumStatus, mockedCapture,
  revenueCatError, mockPaywallState, renderPaywall, containsText, pressByLabel,
