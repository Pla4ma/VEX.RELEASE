...
export const mockPurchase = jest.fn<Promise<PurchaseResult>, [PurchasesPackageDisplayInfo]>();
...
export function revenueCatError(code: RevenueCatError['code'], message: string): RevenueCatError {
  const error = new Error(message);
  error.name = 'RevenueCatError';
  return Object.assign(error, { code });
}

export function packageInfo(identifier: string, packageType: string, priceString: string): PurchasesPackageDisplayInfo {
...
export function mockPaywallState(overrides: Partial<ReturnType<typeof usePaywall>> = {}): void {
...
export async function pressByLabel(output: ReactTestRenderer, label: string): Promise<void> {
