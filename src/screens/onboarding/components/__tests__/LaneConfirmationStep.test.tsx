...
describe('LaneConfirmationStep', () => {
  ...
  describe('LANE_EMOJI', () => {
    it('all four lanes have emojis', () => {
      ...
      for (const key of ['student', 'game_like', 'deep_creative', 'minimal_normal']) {
  ...
  describe('confirmInitialLane copy', () => {
    ...
    it('game_like lane recommends "Run Mode"', () => {
      const result = confirmInitialLane({ primaryGoal: 'focus', motivationStyle: 'game_like', observedAt });
    ...
    it('all confirmations include "You can change this anytime"', () => {
      for (const motivationStyle of ['calm', 'friendly', 'game_like', 'intense', 'study_focused'] as const) {
