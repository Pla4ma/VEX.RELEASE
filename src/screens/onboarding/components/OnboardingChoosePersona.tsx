/**
 * OnboardingChoosePersona Component
 *
 * AI Coach persona selection: Cheerleader, Mentor, Drill Sergeant.
 * Shows 2 example messages from each persona.
 * Skippable, defaults to Mentor.
 *
 * @phase 2.5
 */
 ...
 */
function ExampleMessage({ text, delay }: { text: string; delay: number }): JSX.Element {
...
function PersonaCard({
  ...
  accessibilityHint="Activates this control">
        <Box
          p="lg"
          borderRadius="2xl"
          bg={isSelected ? `${persona.color}15` : theme.colors.background.secondary}
          borderWidth={2}
