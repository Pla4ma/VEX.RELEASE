...
export function OnboardingFlowScreen(): JSX.Element {
  ...
  const handleStartFirstSession = useCallback((): void => {
    ...
    navigation.navigate('SessionStack', {
      screen: 'SessionSetup',
      params: { goal: selectedGoal?.title, presetId: selectedPreset.id, source: 'onboarding_first_session' },
    });
    setIsLaunchingSession(false);
  }, [disclosureAnalytics, navigation, selectedGoal?.title, selectedPreset, userId]);
