...
import { MomentumDots, DailyProgress, SessionStats } from './ActiveSessionHeroSecondary';
...
export const ActiveSessionHero: React.FC<ActiveSessionHeroProps> = ({ viewModel, progressRingProps, themeColors, isReducedMotion }) => (
  <Box flex={1} justifyContent="center" alignItems="center" px="lg">
    <Box alignItems="center">
      ...
      />
      <FocusSignalPill signalPill={viewModel.signalPill} themeColors={themeColors} isReducedMotion={isReducedMotion} withAlpha={progressRingProps.withAlpha} />
      ...
      <SessionStats viewModel={viewModel} labelColor={progressRingProps.labelColor} />
    </Box>
  </Box>
);
...
function FocusSignalPill(props: {
  ...
  if (props.isReducedMotion) {return content;}
  return (
