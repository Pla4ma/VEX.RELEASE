...
import { useNeuroplasticity } from '../../features/neuroplasticity/hooks';
import { NeuroplasticityReadinessCard } from '../../features/neuroplasticity';
...
export const SessionSetupScreen: React.FC = () => {
  ...
  const shouldShowInsurancePrompt = React.useMemo(() => {
    ...
    const hasInsurance = (insuranceStatus as any)?.hasInsurance ?? false;
    return streakDays >= 3 && !hasInsurance && !insurancePromptDismissed;
  }, [controller.streak?.currentDays, (insuranceStatus as any)?.hasInsurance, insurancePromptDismissed]);
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 140 }}>
        ...
        {shouldShowInsurancePrompt && (
          <StreakInsurancePrompt
            ...
            insuranceCost={200}
            userCoins={typeof coinBalance === 'number' ? coinBalance : (coinBalance as any)?.amount ?? 0}
            onPurchase={() => {
        ...
        {/* Cognitive Readiness Indicator */}
        <NeuroplasticityReadinessCard userId={controller.userId} />
