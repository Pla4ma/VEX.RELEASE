...
import { ScrollView, Pressable, Switch, Linking } from "react-native";
...
export const SettingsScreen = withScreenErrorBoundary(function _SettingsScreen({
  ...
  const navigateToLaneMode = () => {
    navigation.navigate("LaneMode");
  };
  const settingGroups: SettingGroup[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: "target",
          title: "Focus Mode",
          subtitle: "Study, Run, Project, or Clean",
          type: "link",
          onPress: navigateToLaneMode,
        },
        {
          id: "account",
          icon: "shield",
