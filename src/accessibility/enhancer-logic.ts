...
export function getAutomaticEnhancements(
  ...
  if (config.autoContrastFixes) {
    Object.assign(
      enhancements,
      getContrastEnhancements(props, config.colorBlindSupport),
    );
  }
...
function getContrastEnhancements(
  props: unknown,
...
function getMotionEnhancements(
  props: unknown,
): Partial<EnhancedAccessibilityProps> {
  const enhancements: Partial<EnhancedAccessibilityProps> = {};
  const sourceProps = props as PropsWithStyle;
...
function getScreenReaderEnhancements(
  props: unknown,
): Partial<EnhancedAccessibilityProps> {
  const enhancements: Partial<EnhancedAccessibilityProps> = {};
  const sourceProps = props as PropsWithStyle;
