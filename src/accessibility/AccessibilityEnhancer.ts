...
export class AccessibilityEnhancer {
  ...
  private getContrastEnhancements<P extends object>(
    props: P & Partial<EnhancedAccessibilityProps>,
  ): Partial<EnhancedAccessibilityProps> {
    const enhancements: Partial<EnhancedAccessibilityProps> = {};
    if (
  ...
  private getFocusEnhancements<P extends object>(
    props: P & Partial<EnhancedAccessibilityProps>,
  ): Partial<EnhancedAccessibilityProps> {
    const enhancements: Partial<EnhancedAccessibilityProps> = {};
    if (
  ...
  private getMotionEnhancements<P extends object>(
    props: P & Partial<EnhancedAccessibilityProps>,
  ): Partial<EnhancedAccessibilityProps> {
    const enhancements: Partial<EnhancedAccessibilityProps> = {};
  ...
  private getScreenReaderEnhancements<P extends object>(
    props: P & Partial<EnhancedAccessibilityProps>,
  ): Partial<EnhancedAccessibilityProps> {
    const enhancements: Partial<EnhancedAccessibilityProps> = {};
