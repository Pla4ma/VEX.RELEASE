...
/**
 * Color-blind palette colors are documented accessibility configuration data.
 * These are alternative palettes required for WCAG compliance, not UI styling.
 */
    ...
    if (element.color && element.backgroundColor) {
      ...
      if (contrast < 4.5) {
        issues.push({
          ...
          suggestion: getAccessibleAlternatives(
            element.color,
            element.backgroundColor,
            4.5,
          )[0]
