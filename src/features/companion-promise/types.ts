...
export type CreateCompanionPromiseInput = z.infer<typeof CreateCompanionPromiseInputSchema>;
export type CompanionPromiseRow = Database['public']['Tables']['companion_promises']['Row'];
export type CompanionPromiseInsert = Database['public']['Tables']['companion_promises']['Insert'];
export type CompanionPromiseUpdate = Database['public']['Tables']['companion_promises']['Update'];
