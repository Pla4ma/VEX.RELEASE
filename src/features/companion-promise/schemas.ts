...
export const CompanionPromiseSchema = z.object({
...
export const CompanionPromiseHomeStateSchema = z.discriminatedUnion('kind', [
  z.object({ kind: z.literal('hidden'), showOfflineBanner: z.boolean() }).strict(),
  z.object({
...
export const CompanionPromiseRepositoryRowSchema = z.object({
...
export const CreateCompanionPromiseInputSchema = z.object({
  createdAt: z.string().datetime(),
...
export const CompletedSessionPromiseInputSchema = z.object({
...
export const CompanionPromiseLifecycleResultSchema = z.object({
