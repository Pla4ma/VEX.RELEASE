...
import {
  getMasteryState,
  recordSessionMastery,
  claimMasteryChallenge,
  getActiveChallenges,
  getTechniqueStats,
  getUnlockedFeatures,
} from '../service';
...
describe('Mastery Service', () => {
  ...
  describe('getMasteryState', () => {
    ...
    it('should correct rank if points threshold crossed', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(incorrectRankState);
  ...
  describe('recordSessionMastery', () => {
    it('should award XP for duration mastery', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(baseState);
    ...
    it('should rank up when threshold crossed', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(nearRankUpState);
    ...
    it('should cap technique values at 25', async () => {
      ...
      expect(result.techniqueGains.durationMastery).toBe(1); // Capped at 25
    });
  });
  ...
  describe('getActiveChallenges', () => {
    it('should return all active challenges', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(stateWithChallenges);
  ...
  describe('getTechniqueStats', () => {
    it('should return technique levels and next milestones', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(stateWithTechniques);
      ...
      expect(stats.consistencyMastery.isPrimary).toBe(true); // Highest
    });
  });
  ...
  describe('getUnlockedFeatures', () => {
    ...
    it('should unlock new features on rank up', async () => {
      ...
      (loadStoredMasteryState as jest.Mock).mockReturnValue(apprenticeState);
