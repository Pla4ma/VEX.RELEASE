...
export function PremiumPreview({
  ...
  daysRemaining,
  hasPremium = false,
}: PremiumPreviewProps): JSX.Element | null {
    ...
    <View style={styles.container}>
            ...
            <View style={styles.headerText}>
              ...
              <Text style={styles.headerSubtitle}>
                {unlockedPremiumTiers > 0
                  ? `${unlockedPremiumTiers} tiers earned but locked!`
                  : 'Unlock 2x rewards on every tier'}
              </Text>
            </View>
          </View>
      ...
      {unlockedPremiumTiers > 0 && (
        <Animated.View
          ...
          style={[styles.retroBanner, { backgroundColor: 'rgba(255, 215, 0, 0.12)' }]}
        >
      ...
      <Animated.View style={[styles.ctaContainer, pulseStyle]}>
        ...
        accessibilityHint="Activates this control">
          {unlockedPremiumTiers > 0
            ? `Claim ${retroactiveValue}+ Gems Now`
