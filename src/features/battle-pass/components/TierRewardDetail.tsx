    ...
    <Animated.View entering={FadeInUp.duration(300)}>
      ...
      >
        ...
        <Box
          ...
          py={1}
          borderRadius={8}
          bg={track === 'FREE' ? theme.colors.success.DEFAULT : theme.colors.warning.DEFAULT}
        ...
        {isClaimed ? (
          ...
          <Button variant="outline" size="lg" fullWidth onPress={onUpgrade}
  accessibilityLabel="👑 Upgrade to Claim button"
  accessibilityRole="button"
  accessibilityHint="Activates this control">
            👑 Upgrade to Claim
          </Button>
        ) : canClaim ? (
          <Button variant="primary" size="lg" fullWidth onPress={onClaim}
...
export const TierRewardDetail: React.FC<TierRewardDetailProps> = ({
  tier,
  currentTier,
  hasPremium,
  onClaimFree,
    ...
    >
      ...
      <Box px={6} mb={4}>
        ...
        <Text variant="caption" color={theme.colors.text.tertiary} textAlign="center" mt={1}>
          {tier.tierNumber <= currentTier
            ? 'Tier completed!'
            : `${tier.tierNumber - currentTier} tiers away`}
        </Text>
      </Box>
      ...
      <Box px={6} gap={4}>
        ...
        {tier.freeReward && (
          <RewardCard
            ...
            isClaimed={tier.freeStatus === 'CLAIMED'}
        ...
        {tier.premiumReward && (
          <RewardCard
            ...
            isClaimed={tier.premiumStatus === 'CLAIMED'}
      ...
      {!hasPremium && tier.premiumReward && (
        <Box px={6} mt={4}>
          ...
          >
            ...
            <Button variant="primary" size="lg" fullWidth onPress={onUpgrade}
  ...
  accessibilityHint="Activates this control">
      ...
      {/* Close button */}
      <Box px={6} py={4}>
        <Button variant="ghost" size="md" fullWidth onPress={onClose}
