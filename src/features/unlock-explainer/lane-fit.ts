...
export const LANE_FEATURE_FIT: Record<
  string,
  Record<string, 'strong' | 'medium' | 'weak' | 'blocked'>
> = {
  study_os: {
    student: 'strong',
...
export function resolveLaneFit(
  featureKey: string,
  lane?: string,
): 'strong' | 'medium' | 'weak' | 'blocked' {
...
export function resolveMinSessions(
