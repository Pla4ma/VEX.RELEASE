...
export { buildHomeExperienceModel, getHomeStage, decideHomeSurfaces, getSpotlightSurface };
...
export function baseStats(sessions = 0) {
  return {
...
export function visibleNonHidden(map: HomeSurfaceMap): string[] {
