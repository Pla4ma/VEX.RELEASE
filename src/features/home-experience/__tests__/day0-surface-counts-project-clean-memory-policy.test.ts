...
import {
  featureAvailability, baseStats, day0Map,
...
describe('Phase 3 — Day 0 lane surface counts', () => {
    ...
    it('project_thread is hidden/blocked on Day 0 regardless of hasActiveStudyPlan', () => {
      const map = decideHomeSurfaces({
        ...
        personalizationProfile: {
          motivationStyle: 'coach_led', primaryGoal: 'creative',
          gamificationIntensity: 'medium', studyLayerName: 'Study OS', userStage: 'new',
        },
  ...
  describe('Clean Home (minimal_normal) zero clutter', () => {
    it('minimal_normal Day 0 has no boss teaser', () => {
      const map = day0Map({
        motivationStyle: 'calm', gamificationIntensity: 'minimal',
    ...
    it('minimal_normal after Day 0 has today_strip, no boss/challenge clutter', () => {
      const map = decideHomeSurfaces({
        ...
        personalizationProfile: {
          ...
          gamificationIntensity: 'minimal', studyLayerName: 'Growth Path', userStage: 'engaged',
        },
    ...
    it('memory_insight hidden when < 3 sessions', () => {
      const map = decideHomeSurfaces({
        ...
        personalizationProfile: {
          ...
          gamificationIntensity: 'medium', studyLayerName: 'Study OS', userStage: 'activating',
        },
