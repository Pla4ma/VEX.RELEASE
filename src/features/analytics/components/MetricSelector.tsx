...
export function MetricSelector({
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable
        style={({ pressed }) => [styles.selector, disabled && styles.selectorDisabled, pressed && { opacity: 0.8 }]}
  ...
  accessibilityHint="Activates this control">
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              ...
              <Pressable onPress={() => setModalVisible(false)} style={({ pressed }) => [pressed && { opacity: 0.8 }]}
