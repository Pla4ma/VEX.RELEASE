...
const CATEGORIES: Array<{
...
}> = [
  {
    ...
    label: "Everything",
    icon: "\uD83D\uDCE6",
    description: "All your data in one export",
  },
  {
    key: "sessions",
    label: "Sessions",
    icon: "\uD83D\uDCC5",
    description: "Session history and stats",
  },
  {
    key: "analytics",
    label: "Analytics",
...
const FORMATS: Array<{
...
}> = [
  {
    ...
    label: "JSON",
    icon: "\uD83D\uDCC4",
    description: "Machine-readable, great for backups",
  },
  {
    key: "csv",
    label: "CSV",
...
export function DataExportScreen({ userId, onClose }: DataExportScreenProps) {
  ...
  const confirmExport = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert(
        "Export Started",
        "Your data export has been queued. You'll be notified when it's ready.",
        [{ text: "OK" }],
      );
    } catch (error) {
      Alert.alert(
        "Export Failed",
        "Unable to start export. Please try again.",
        [{ text: "OK" }],
      );
    }
            ...
            <View style={styles.optionRow}>
              <View style={styles.optionInfo}>
                ...
                <Text style={styles.optionSubtitle}>
                  Timestamps, device info, app version
                </Text>
              </View>
              <Switch
                ...
                trackColor={{
                  false: launchColors.hex_e5e7eb,
                  true: launchColors.hex_6366f1,
                }}
              />
            </View>
          </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <Text style={styles.modalDescription}>
              We'll prepare your{" "}
              {CATEGORIES.find((c) => c.key === selectedCategory)?.label} data
              as a {selectedFormat.toUpperCase()} file. This may take a few
              minutes.
            </Text>
...
const styles = createSheet({
  ...
  optionCardSelected: {
    ...
    backgroundColor: launchColors.hex_eef2ff,
  },
