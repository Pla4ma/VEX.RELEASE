...
export function AnalyticsDashboard({
  ...
  const handleRefresh = useCallback(async () => {
    ...
    } catch (error) { captureSilentFailure(error, { feature: 'analytics', operation: 'ui-fallback', type: 'ui' });
      return;
    }
            ...
            {insights && insights.length > 0 && (
              <View style={styles.insightsSection}>
                <View style={styles.sectionHeader}>
                  ...
                  {insights.length > 5 && (
                    <Pressable accessibilityLabel="View all insights" accessibilityRole="button"
                      accessibilityHint="Activates this control" style={({ pressed }) => [pressed && { opacity: 0.8 }]}>
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl refreshing={dashboardState === 'loading'} onRefresh={handleRefresh} tintColor="#6366f1" />
        }
