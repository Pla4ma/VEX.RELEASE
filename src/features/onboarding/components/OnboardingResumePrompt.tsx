...
export function OnboardingResumePrompt({
  ...
  const getProgressSummary = (): string => {
    ...
    if (completed.length === 0) {return 'You started but didn\'t complete any steps.';}
              ...
              <Animated.View entering={FadeInUp.delay(200)}>
                <Box bg={theme.colors.warning.light} p="md" borderRadius="lg" mb="lg">
                  <Text variant="bodySmall" color={theme.colors.warning.DEFAULT} textAlign="center">
                    ⚠️ We noticed you've had trouble completing setup.
                    It only takes 2 minutes to finish!
                  </Text>
                </Box>
              </Animated.View>
            )}
