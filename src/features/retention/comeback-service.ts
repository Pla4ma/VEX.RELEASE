...
export function generateComebackQuest(
  userId: string,
...
export function qualifiesForComeback(
  daysSinceLastSession: number,
  ...
  return (
    ...
    (daysSinceLastSession >= 1 && currentStreak === 0) ||
...
export async function completeComebackQuest(
  userId: string,
  questId: string
...
export function calculateReEngagementProbability(
  daysSinceLastSession: number,
