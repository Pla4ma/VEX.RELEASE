...
export const EarningMultiplierSchema = z.object({
  source: TransactionSourceSchema,
...
export const SpendingSinkSchema = z.object({
  id: z.string().uuid(),
...
export const InitiatePurchaseInputSchema = z.object({
  userId: z.string().uuid(),
  shopItemId: z.string().uuid(),
...
export const LimitedOfferSchema = z.object({
  id: z.string().uuid(),
...
export const UserOfferClaimSchema = z.object({
  id: z.string().uuid(),
...
export const CheckOfferEligibilityInputSchema = z.object({
  offerId: z.string().uuid(),
  userId: z.string().uuid(),
  userLevel: z.number().int().min(1),
...
export const AddCurrencyInputSchema = z.object({
  userId: z.string().uuid(),
  currency: CurrencyTypeSchema,
  amount: z.number().int().positive(),
  source: TransactionSourceSchema,
...
export const SpendCurrencyInputSchema = z.object({
  userId: z.string().uuid(),
  currency: CurrencyTypeSchema,
  amount: z.number().int().positive(),
