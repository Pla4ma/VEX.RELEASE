...
describe('EarnPremiumSystem', () => {
  ...
  describe('claimReward', () => {
    it('successfully claims an unlocked reward', () => {
      ...
      const result = earnPremiumSystem.claimReward(
        status,
      ...
      const claimedReward = result.status.rewards.find(
    ...
    it('fails to claim if reward already claimed', () => {
      ...
      // First claim
      const firstResult = earnPremiumSystem.claimReward(
        status,
        EarnPremiumAchievementType.STREAK_30_DAYS
      );
      ...
      const secondResult = earnPremiumSystem.claimReward(
        firstResult.status,
        EarnPremiumAchievementType.STREAK_30_DAYS
      );
  ...
  describe('getAvailableRewards', () => {
    it('returns only unlocked and unclaimed rewards', () => {
      ...
      // Claim one reward
      const claimResult = earnPremiumSystem.claimReward(
        status,
        EarnPremiumAchievementType.STREAK_30_DAYS
      );
