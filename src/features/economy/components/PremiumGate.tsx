...
const FEATURE_GATE_MAP: Record<PremiumGateFeature, FeatureGateInfo> = {
  ...
  ai_coach_persona_drill_sergeant: {
    ...
    description:
      'The Drill Sergeant persona is only available with Premium. Get intense, zero-tolerance coaching when you need maximum accountability.',
  ...
  boss_tier_4: {
    ...
    description:
      'The Perfectionist boss awaits Premium users. Defeat it to unlock Tier 5 and the ultimate challenge.',
  ...
  boss_tier_5: {
    ...
    description:
      'Master of Multitasking is a Premium-only boss. Can you focus long enough to defeat it?',
  ...
  boss_tier_6: {
    ...
    description:
      'Burnout Beast is the ultimate squad boss raid, exclusively for Premium users who have conquered all before it.',
  ...
  inventory_expansion: {
    ...
    description:
      'Premium unlocks 500 inventory slots so you can collect every cosmetic, ingredient, and legendary item.',
  ...
  advanced_analytics: {
    ...
    description:
      'Premium gives you deeper insights into when you focus best and where your momentum starts leaking.',
  ...
  content_study: {
    ...
    description:
      'Premium expands VEX into a deeper work tool once your focus habit is already taking hold.',
  ...
  squad_challenges: {
    ...
    description:
      'Premium unlocks advanced squad challenge modes for competitive focus with your team.',
...
export function PremiumGate({
  ...
  return (
    <Animated.View entering={FadeInUp.duration(300)} style={styles.container}>
      ...
      >
        ...
        {featureInfo.unlocks.map((unlock, index) => (
          <View key={index} style={styles.unlockRow}>
            ...
            />
            <Text
              style={[styles.unlockText, { color: theme.colors.text.secondary }]}
            >
              {unlock}
            </Text>
          </View>
      ...
      <View style={styles.actions}>
        <Button variant="primary" size="lg" onPress={handleUpgrade}
  ...
  accessibilityHint="Activates this control">
      ...
      <Pressable style={styles.earnOption} onPress={handleUpgrade}
  accessibilityLabel="Or earn Premium free through achievements → button"
  accessibilityRole="button"
  accessibilityHint="Activates this control">
        <Text
          style={[styles.earnText, { color: theme.colors.text.tertiary }]}
        >
          Or earn Premium free through achievements →
        </Text>
      </Pressable>
    </Animated.View>
  );
