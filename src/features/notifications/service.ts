...
/**
 * Notification rule: Streak at risk
 */
export function shouldNotifyStreakAtRisk(context: NotificationContext): {
  ...
  const urgency = streakRisk.riskLevel === 'CRITICAL'
    ? '🚨 LAST CHANCE'
...
/**
 * Notification rule: Boss escape imminent
 */
...
/**
 * Notification rule: Squad streak at risk
 */
...
/**
 * Notification rule: Rival pulling ahead
 */
...
/**
 * Notification rule: Chest inventory full
 */
...
/**
 * Notification rule: Challenge expiring
 */
...
/**
 * Notification rule: Season ending with unclaimed rewards
 */
...
/**
 * Social notification: Rival completed session
 */
...
/**
 * Social notification: Squad member nudge
 */
...
/**
 * Social notification: Squad milestone
 */
...
/**
 * Social notification: Feed reaction
 */
...
/**
 * Evaluate all notification rules and return highest priority notification
 */
...
/**
 * Check daily notification limit using MMKV
 */
...
/**
 * Record notification sent (for daily limit tracking)
 */
...
export async function dispatchUrgencyNotification(
  ...
  quietStart: number = DEFAULT_QUIET_START_HOUR,
  quietEnd: number = DEFAULT_QUIET_END_HOUR
): Promise<{ sent: boolean; reason?: string; deferred?: boolean; nextWindow?: Date }> {
  // Check quiet hours
