...
export const ReminderPlanRowSchema = z
  .object({
    id: z.string().uuid(),
...
export const RetentionUserProfileSchema = z
  .object({
    id: z.string().uuid(),
...
export const ChallengeExpiryCandidateSchema = z
  .object({
    userId: z.string().uuid(),
...
export type ChallengeExpiryCandidate = z.infer<
  typeof ChallengeExpiryCandidateSchema
>;
export type NotificationCenterType = z.infer<
  typeof NotificationCenterTypeSchema
>;
export type NotificationCenterItem = z.infer<
