...
export const PAYWALL_CONTEXTS: Record<PaywallContextType, PaywallContextData> =
  {
    DEEP_COACH_MEMORY: {
      ...
      subtext:
        "VEX remembers your best focus times, comeback style, and preferred push intensity — then adapts every session to you.",
    ...
    PREMIUM_SESSION_MODES: {
      ...
      statText: "Friction mode users complete 35% more sessions",
      ctaText: "Unlock Advanced Modes",
      secondaryCtaText: "Maybe Later",
    },
    RECOVERY_PLANNING: {
