...
export function trackItemDefinitionLoaded(
...
export function trackItemEffectApplied(
  userId: string,
  itemDefinitionId: string,
  effects: string[]
): void {
...
export function trackItemEffectFailed(
  userId: string,
  itemDefinitionId: string,
  effectType: string,
  error: string
...
export function trackCraftingChecked(
  userId: string,
  itemDefinitionId: string,
  canCraft: boolean
): void {
...
export function trackCraftingMaterialsRecovered(
  userId: string,
  itemDefinitionId: string,
...
export function trackDropTableRolled(
  tableId: string,
  rollCount: number,
  resultsCount: number
): void {
...
export function trackItemDropped(
  userId: string,
  itemDefinitionId: string,
  quantity: number,
  source: string
...
export function trackItemPurchaseChecked(
  userId: string,
  itemDefinitionId: string,
  canPurchase: boolean,
  reason: string | null
...
export function trackItemValueCalculated(
  itemDefinitionId: string,
  baseValue: number,
  finalValue: number,
...
export function trackItemsCompared(
  itemAId: string,
  itemBId: string,
  betterStats: string[]
): void {
...
export function trackItemDefinitionLoadFailed(
  itemDefinitionId: string,
  error: unknown
): void {
...
export function trackInvalidItemData(
  itemDefinitionId: string,
...
export function trackDropTableError(
  tableId: string,
  error: string
): void {
