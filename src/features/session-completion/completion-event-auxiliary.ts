/**
 * Session Completion Event Types — Auxiliary
 *
 * Reward, feedback, social, and system event types, plus the union type.
 */
...
} from './completion-event-types';

export type {
  BaseSessionCompletionEvent, EventMetadata, DeviceInfo,
  SessionCompletedEvent, SessionAbortedEvent, SessionTimeoutEvent,
  SessionPerformanceCalculatedEvent, SessionAnalyticsGeneratedEvent, SessionPerformanceReportEvent,
  SessionMilestoneReachedEvent, SessionRecordBrokenEvent,
