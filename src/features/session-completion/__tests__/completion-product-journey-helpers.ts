...
export const focusIdentityUpdateMock = require('../../focus-identity/update-focus-score.helper')
  .updateFocusScoreFromSessionCompletion;

export function resetCompletionMocks(): void {
  jest.clearAllMocks();
  setFeatureAccessMap({
    companion_detail: {
