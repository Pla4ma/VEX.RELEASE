...
export const FEATURE_COPY: Partial<Record<FeatureKey, FeatureCopy>> = {
  battle_pass: {
    lockedDescription:
      'Season progress is archived until separately approved.',
    recommendedUnlockMoment: 'Not part of final release',
    unlockReason:
      'Archived until separately approved.',
  },
  boss_tab: {
  ...
  economy_basic: {
    lockedDescription: 'Spendable rewards stay archived so XP, streaks, and progress remain the focus.',
    recommendedUnlockMoment: 'Not part of final release',
