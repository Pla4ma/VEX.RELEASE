...
const ACTIVE: FeatureClassificationEntry[] = [
  ...
  { systemId:'focus_memory', folder:'focus-memory', status:'final_release_active', minSessions:0, routeAllowed:false, homeAllowed:false, queryAllowed:true, subscriptionAllowed:false, notificationAllowed:false, completionAllowed:true, premiumCopyAllowed:false, appStoreCopyAllowed:false, notes:'Inspectable memory ledger. No route until Memory Console phase.' },
