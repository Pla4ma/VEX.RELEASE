...
export type FinalReleaseStatus = 'included' | 'progressive' | 'hidden' | 'premium_gated';
...
export const FINAL_RELEASE_FEATURE_MAP: Record<FeatureKey, FinalReleaseFeatureEntry> = {
