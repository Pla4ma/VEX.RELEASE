...
export const CriticalHitOverlay: React.FC<CriticalHitOverlayProps> = ({
  sessionId,
  visible,
  onDismiss,
  bossName,
      ...
      >
        <Box flexDirection="row" alignItems="center" gap={3}>
          ...
          <Box flex={1}>
            ...
            <Text variant="bodySmall" color={theme.colors.text.secondary} mt={1}>
              {bossName
                ? `Maintain focus to deal CRITICAL damage to ${bossName}!`
                : 'Maintain focus for 2x damage!'}
            </Text>
        ...
        >
          <Box alignItems="center">
            <Text variant="caption" color={theme.colors.text.tertiary}>Normal Damage</Text>
            <Text variant="body" color={theme.colors.text.secondary}>1x</Text>
          </Box>
          <Box alignItems="center">
            <Text variant="caption" color={theme.colors.warning.DEFAULT}>Critical Damage</Text>
            <Text variant="body" color={theme.colors.warning.DEFAULT} fontWeight="bold">2x ⚡</Text>
          </Box>
        </Box>
      </Box>
    </Animated.View>
...
export const NearMissDisplay: React.FC<NearMissDisplayProps> = ({
  nearMissPercent,
  baseDamage,
  potentialCritDamage,
}) => {
  ...
  return (
    <Animated.View style={containerStyle}>
      ...
      >
        ...
        >
          <Box alignItems="center">
            <Text variant="caption" color={theme.colors.text.tertiary}>Dealt</Text>
          ...
          <Box alignItems="center">
            <Text variant="caption" color={theme.colors.warning.DEFAULT}>Could Have Been</Text>
