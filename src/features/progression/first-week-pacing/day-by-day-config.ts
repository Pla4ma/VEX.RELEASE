...
export const FIRST_WEEK_DAY_DESIGN: DayDesign[] = [
  {
    ...
    theme: 'Start',
    description:
      'Your first session. No extra systems, no pressure. Just focus.',
    promptTitle: 'Let your first session begin',
    promptBody:
      'One focused session is all that matters today. Everything else comes after.',
    unlocks: ['focus_score'],
  },
  {
    day: 1,
    ...
    theme: 'Rhythm',
    description:
      'Welcome back. Protect your rhythm with one clean session today.',
    promptTitle: 'Welcome back',
    promptBody:
      'Your rhythm starts today. One session protects it for tomorrow.',
  ...
  },
  {
    ...
    theme: 'Proof',
    description:
      'See what you have built: minutes focused, streak alive, growth visible.',
  ...
  },
  {
    ...
    promptBody:
      'A creature that grows with every session you complete. Meet it today.',
  ...
  },
  {
    ...
    theme: 'Strength',
    description:
      'Your focus patterns are forming. VEX starts learning from them.',
    promptTitle: 'Your focus pattern is forming',
    promptBody:
      'The app now knows your rhythm and can recommend better sessions.',
  ...
  },
  {
    ...
    promptBody:
      'A small target based on your own history. No comparison, just your next step.',
  ...
  },
  {
    ...
    promptBody:
      'Your first week is done. Now choose what VEX becomes for you: calm companion, study coach, or game-like challenger.',
