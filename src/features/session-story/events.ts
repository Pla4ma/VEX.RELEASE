...
export interface StoryPerformanceReportEvent extends BaseSessionStoryEvent {
  ...
  data: {
    ...
    engagement: {
      byGenre: Record<string, any>;
      byLength: Record<string, any>;
      byDifficulty: Record<string, any>;
      byTheme: Record<string, any>;
    };
    choices: {
    ...
    progression: {
      completionRates: Array<{ date: Date; rate: number }>;
      engagementScores: Array<{ date: Date; score: number }>;
      choicePatterns: Array<{ date: Date; pattern: string }>;
    };
    insights: {
      strengths: string[];
      improvements: string[];
...
export type SessionStoryEventType =
  ...
  | NarrativeCharacterIntroducedEvent
  | NarrativeEventOccurredEvent
  | NarrativeTwistRevealedEvent
  | StoryChoicePresentedEvent
  | StoryChoiceMadeEvent
  | StoryChoiceConsequenceEvent
  | CharacterRelationshipChangedEvent
  | CharacterDevelopmentEvent
  | WorldElementDiscoveredEvent
  | WorldStateChangedEvent
  | StoryAchievementUnlockedEvent
  | StoryMilestoneReachedEvent
  | StoryAnalyticsEvent
  | StoryPerformanceReportEvent
  | StorySystemMaintenanceEvent
  | StorySystemErrorEvent;
...
export function createStoryAchievementUnlockedEvent(
  ...
  achievementId: string,
  achievementName: string,
  achievementType: 'discovery' | 'mastery' | 'relationship' | 'choice' | 'exploration' | 'completion',
  progress: any,
  criteria: any[],
