...
const CRITICAL_HOURS_THRESHOLD = 3;
const GAMBLE_SUCCESS_GRADES = ["S", "A"];
const GAMBLE_BONUS_XP = 50;
export const StreakGamblePrompt: React.FC<StreakGamblePromptProps> = ({
  ...
  const handleSessionComplete = (grade: "S" | "A" | "B" | "C" | "D") => {
    ...
    Sentry.addBreadcrumb({
      ...
      data: { grade, streakDays, xpEarned: outcome.xpEarned },
    });
