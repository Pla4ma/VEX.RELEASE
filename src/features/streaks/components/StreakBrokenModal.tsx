      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Button variant="primary" size="lg" fullWidth onPress={onStartFresh}
  accessibilityLabel="🔥 Start Fresh button"
  accessibilityRole="button"
  accessibilityHint="Activates this control">
                🔥 Start Fresh
              </Button>
              <Button variant="ghost" size="md" fullWidth onPress={onDismiss}
