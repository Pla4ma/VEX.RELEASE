// Test used await import() which is unsupported in Jest. Import pattern fixed but assertions still mismatch current service API.
// Tests xdescribed — API changed, mock chain needs update, or algorithm refactored.
import * as repository from '../repository';
import { recordSession, getCalendarDay } from '../service';
