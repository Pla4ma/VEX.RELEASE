...
export interface Achievement {
  ...
  // Metadata
  unlockedAt?: number;
  unlockRate?: number; // 0-1, affects display (% of users who have this)
}
...
// Total count
export const ACHIEVEMENT_COUNT = ALL_ACHIEVEMENTS.length; // Should be 24
...
/**
 * Get display info for an achievement (respecting hidden status)
 */
