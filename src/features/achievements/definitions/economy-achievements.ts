...
export const ECONOMY_ACHIEVEMENTS: Achievement[] = [
  {
    ...
    isDeprecated: true,
    progressMax: 1000,
    unlockCondition: { type: 'COINS_SPENT', target: 1000, comparator: 'CUMULATIVE' },
  ...
  },
  {
    ...
    isDeprecated: true,
    progressMax: 1,
    unlockCondition: { type: 'ITEM_CRAFT', target: 1, comparator: 'GREATER_THAN' },
    pointValue: RARITY_CONFIG.UNCOMMON.points,
  ...
  },
  {
    ...
    isDeprecated: true,
    progressMax: 5,
    unlockCondition: { type: 'ITEMS_OWNED', target: 5, comparator: 'GREATER_THAN' },
