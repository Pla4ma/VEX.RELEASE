...
export type ContentStudyVisibility = z.infer<
  typeof ContentStudyVisibilitySchema
>;
...
function canUseContentStudyBackend(
...
export function buildContentStudyVisibility(
  input: ContentStudyVisibilityInput,
