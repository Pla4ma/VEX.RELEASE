...
export const CreateMemoryCandidateInputSchema = z
  .object({
    userId: z.string().min(1),
    type: FocusMemoryTypeSchema,
    summary: z.string().min(1),
...
export const MemoryRecommendationInputSchema = z
  .object({
    userId: z.string().min(1),
...
>;
export type CreateMemoryCandidateInput = z.infer<
  typeof CreateMemoryCandidateInputSchema
>;
export type FocusMemory = z.infer<typeof FocusMemorySchema>;
export type FocusMemoryType = z.infer<typeof FocusMemoryTypeSchema>;
export type MemoryRecommendationInput = z.infer<
  typeof MemoryRecommendationInputSchema
>;
