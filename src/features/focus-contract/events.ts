...
export function publishContractSkipped(input: { sessionId: string; userId: string }): void {
  eventBus.publish('focus-contract:skipped', input);
}

export function publishContractDoneMilestone(input: { contractId: string; userId: string }): void {
