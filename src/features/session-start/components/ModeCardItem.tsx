...
import { ModeCard } from './ModeSelector.data';
    ...
    >
      ...
      >
        <Box flexDirection="row" alignItems="center" gap="md">
          ...
          >
            <SessionGlyph name={card.glyph as SessionGlyphName} size={44} />
          </Box>
          <Box flex={1}>
          ...
          >
            <Text variant="caption" color="text.secondary">
              {card.mode === 'CAPTURE' || card.mode === 'PLAN' || card.mode === 'REVIEW' || card.mode === 'HABIT' ? 'No timer' : 'Timer'}
            </Text>
          </Box>
        </Box>
      </Box>
