...
}); } if (params.source === "content-study" || params.source === "learning-execution") { return SessionStartHeroSchema.parse({ eyebrow: params.learningExecutionLabel ?? "Deep Work Sprint", title: "Turn this plan into a focused block now",
