...
export const CompanionEvolutionCeremony: React.FC<CompanionEvolutionCeremonyProps> = ({
  previousState,
  newPhase,
  onComplete,
}) => {
  ...
  accessibilityHint="Activates this control">
      ...
      >
        ...
        <Box
          ...
          zIndex={35}
        >
          {(['energy-buildup', 'flash', 'transformation', 'celebration'] as EvolutionPhase[]).map(
            (phase, index) => {
              const isActive =
                ceremonyPhase === phase ||
              ...
              const isPast =
                ceremonyPhase !== 'complete' &&
                ['transformation', 'celebration', 'complete'].includes(ceremonyPhase) &&
              ...
              return (
                <Box
                  ...
                  height={8}
                  borderRadius="full"
                  bg={isActive ? themeColors.primary : isPast ? themeColors.glow : 'background.tertiary'}
