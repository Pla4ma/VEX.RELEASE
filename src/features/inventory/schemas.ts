...
export const LoadoutSummarySchema = z.object({
...
export const LoadoutOptionsSchema = z.object({
...
export const UseItemResultSchema = z.object({
  success: z.boolean(),
...
export const UnequipItemResultSchema = z.object({
  success: z.boolean(),
  itemId: z.string().uuid(),
  slot: EquipmentSlotSchema,
...
export const DestroyItemResultSchema = z.object({
  success: z.boolean(),
  itemId: z.string().uuid(),
...
export const RemoveItemFromInventoryInputSchema = z.object({
  userId: z.string().uuid(),
...
export const DestroyItemInputSchema = z.object({
  userId: z.string().uuid(),
  inventoryItemId: z.string().uuid(),
  quantity: z.number().int().min(1).default(1),
  reason: z.string().min(1).max(200),
...
export const StackItemsInputSchema = z.object({
  userId: z.string().uuid(),
  targetItemId: z.string().uuid(),
  sourceItemIds: z.array(z.string().uuid()).min(1),
}).strict();

export const SplitStackInputSchema = z.object({
  userId: z.string().uuid(),
  inventoryItemId: z.string().uuid(),
  splitQuantity: z.number().int().min(1),
}).strict();

export const SetQuickUseSlotInputSchema = z.object({
  userId: z.string().uuid(),
