...
export const UseConsumableFlow: React.FC<UseConsumableFlowProps> = ({
  item,
  itemDefinition,
  visible,
  onClose,
  ...
  const effect = itemDefinition?.effectType
    ? CONSUMABLE_EFFECTS[itemDefinition.effectType]
    : null;
            ...
            >
              ...
              <Text variant="caption" color="text.secondary">
                Duration: {effect.duration >= 60
                  ? `${Math.floor(effect.duration / 60)} hour${effect.duration >= 120 ? 's' : ''}`
