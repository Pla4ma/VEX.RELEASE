          ...
          >
            ...
            <Box flexDirection="row" justifyContent="center" alignItems="center">
              ...
              <Box flexDirection="row" alignItems="center">
                <Icon
                  name={item.currency === 'GEMS' ? 'gem' : 'coins'}
                  size={14}
...
export const FeaturedShopSection: React.FC<FeaturedShopSectionProps> = ({
  items,
  onItemPress,
}) => {
  const { theme } = useTheme();
    ...
    <Box mb={24}>
      ...
      >
        ...
        <Box
          ...
          borderRadius={8}
          style={{
            backgroundColor: isLastChance
              ? '#EF4444' + '15'
              : theme.colors.background.secondary,
            borderWidth: 1,
            borderColor: isLastChance
              ? '#EF4444' + '30'
        ...
        >
          <Box flexDirection="row" alignItems="center">
            <Icon
              name="clock"
              size={12}
              color={isLastChance ? '#EF4444' : theme.colors.text.tertiary}
            />
            <Text
              variant="caption"
              style={{
