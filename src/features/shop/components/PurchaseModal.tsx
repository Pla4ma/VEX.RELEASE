        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.priceDisplay}>
            ...
            <View style={styles.finalPriceRow}>
              ...
              <View style={styles.finalPriceValue}>
                ...
                <Text style={[styles.finalPrice, !canAfford && styles.priceUnaffordable]}>
          ...
          {!canAfford && (
            <Text style={styles.errorText}>
              Insufficient coins. Need {price - userCoins} more.
            </Text>
          )}

          <View style={styles.modalActions}>
            <Pressable onPress={onCancel} style={({ pressed }) => [styles.cancelButton, pressed && { opacity: 0.8 }]} disabled={isProcessing}
            ...
            <Pressable
              onPress={onConfirm}
              style={({ pressed }) => [styles.confirmButton, (!canAfford || isProcessing) && styles.confirmButtonDisabled, pressed && { opacity: 0.8 }]}
