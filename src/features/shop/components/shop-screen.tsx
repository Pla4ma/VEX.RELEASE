  ...
  return (
    <View style={(styles as any).container}>
      ...
      <ScrollView
        ...
        style={(styles as any).categoryBar}
        contentContainerStyle={(styles as any).categoryContent}
      >
        {CATEGORIES.map(cat => (
          <Pressable
            key={cat.key}
            ...
            style={({ pressed }) => [
              (styles as any).categoryButton,
              selectedCategory === cat.key && (styles as any).categoryButtonActive,
              pressed && { opacity: 0.8 },
            ]}
            ...
            <Text style={[
              (styles as any).categoryIcon,
              selectedCategory === cat.key && (styles as any).categoryIconActive,
            ]}>
              {cat.icon}
            </Text>
            <Text style={[
              (styles as any).categoryLabel,
              selectedCategory === cat.key && (styles as any).categoryLabelActive,
            ]}>
              {cat.label}
            </Text>
          </Pressable>
                ...
                <View style={styles.grid}>
                  ...
                  return (
                    <ShopItemCard
                      key={offer.id}
                      item={item}
                      offer={offer as LimitedOffer}
                      userLevel={userLevel}
                      onPress={() => handleItemPress(item, offer as LimitedOffer)}
      ...
      <PurchaseModal
        ...
        isProcessing={initiatePurchase.isPending || completePurchase.isPending}
      />
