...
describe('ShopEconomy', () => {
  ...
  describe('earnCoins', () => {
    ...
    it('should publish currency:earned event', () => {
      ...
      expect(eventBus.publish).toHaveBeenCalledWith('currency:earned', expect.objectContaining({
        userId,
        currency: 'COINS',
        amount: 50,
        newBalance: 50,
  ...
  describe('spendCoins', () => {
    ...
    it('should publish currency:spent event on success', () => {
      ...
      expect(eventBus.publish).toHaveBeenCalledWith('currency:spent', expect.objectContaining({
        currency: 'COINS',
        amount: 500,
        newBalance: 500,
      }));
