...
export function PremiumChestEffects({
  children,
  style,
}: PremiumChestEffectsProps): JSX.Element {
  ...
  return (
    <View style={[styles.container, style]}>
      ...
      {isPremium && (
        ...
        >
          <Text style={[styles.bonusIcon, { color: theme.colors.warning.DEFAULT }]}>
            ✨
          </Text>
          <Text style={[styles.bonusText, { color: theme.colors.warning.dark }]}>
            +10% Premium Bonus
          </Text>
        </Animated.View>
      )}
