        ...
        >
          ...
          >
            ...
            <Pressable
              ...
              style={({ pressed }) => [styles.chest, pressed && { opacity: 0.8 }, { borderColor: chestStyle.borderColor }]}
              accessibilityLabel="Interactive control"
              accessibilityRole="button"
              accessibilityHint="Activates this control">
              <LinearGradient
                colors={chestStyle.colors as [string, string]}
                style={[
                  styles.chest,
                  isOpen && styles.chestOpen,
                ]}
              >
                <Text style={styles.chestEmoji}>
                  {isOpen ? '✨' : chestStyle.emoji}
                </Text>
          ...
          {isOpen && (
            <View style={styles.rewardsContainer}>
                ...
                {rewards.map((reward, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Text style={[styles.rewardIcon, { color: rarity.color }]}>
                          {getRewardIcon(reward.type)}
                        </Text>
                        <Text style={[styles.rewardAmount, { color: rarity.color }]}>
              ...
              {/* Claim Button */}
              <Pressable style={({ pressed }) => [styles.claimButton, pressed && { opacity: 0.8 }]} onPress={onClaim}
                accessibilityLabel="CLAIM ALL button"
                accessibilityRole="button"
                accessibilityHint="Activates this control">
                <LinearGradient
