  ...
  return (
    ...
    >
      ...
      <Box
        ...
        height={28}
        borderRadius="full"
        bg={status === 'current' ? 'primary.500' : 'background.tertiary'}
      ...
      >
        <Text
          fontSize={12}
          color={status === 'current' ? 'text.inverse' : 'text.tertiary'}
      ...
      <Box
        ...
        height={40}
        borderRadius="lg"
        bg={status === 'current' ? `${theme.colors.primary[500]}30` : 'background.secondary'}
        borderWidth={status === 'current' ? 2 : 0}
        borderColor={status === 'current' ? 'primary.500' : undefined}
        justifyContent="center"
        alignItems="center"
      >
      ...
      <Text
        variant="caption"
        color={status === 'current' ? 'primary.500' : 'text.tertiary'}
...
export function DailyLoginModal({
          ...
          >
              ...
              <Box flexDirection="row" justifyContent="space-between">
                {REWARD_SCHEDULE.map((reward, index) => {
                  ...
                  const status: 'past' | 'current' | 'future' =
                    day < currentDay ? 'past' : day === currentDay ? 'current' : 'future';
            ...
            <Box p="xl" style={{ borderTopWidth: 1, borderTopColor: theme.colors.border.light }}>
              {claimed ? (
                ...
                <Button variant="primary" size="lg" fullWidth onPress={handleClaim}
  ...
  accessibilityHint="Activates this control">
            ...
            {/* Flying reward animation */}
            {showFlyingReward && currentReward && (
              <FlyingReward reward={currentReward} onComplete={handleFlyingComplete} />
            )}
          </Box>
        </Animated.View>
      </Box>
