...
export const RewardLedgerSchema = z.object({
  id: z.string().uuid(),
  rewardId: z.string().uuid(),
...
export const RewardMultiplierSchema = z.object({
  source: z.string(),
  value: z.number(),
  description: z.string(),
}).strict();

export const RewardBonusSchema = z.object({
  source: z.string(),
  amount: z.number(),
  description: z.string(),
}).strict();
...
export const ChestTierSchema = z.enum([
  'common',
  'rare',
  'epic',
  'legendary',
...
export const ChestRollInputSchema = z.object({
...
export const ChestResultSchema = z.object({
...
export const MilestoneRewardItemSchema = z.object({
  type: RewardTypeSchema,
  amount: z.number().min(0),
  itemId: z.string().nullable(),
...
export const CalculateRewardInputSchema = z.object({
  triggerType: RewardTriggerSchema,
  baseAmount: z.number().min(0),
