...
export const JoinRequirementSchema = z.enum([
  'OPEN',
  'APPROVAL',
  'INVITE_ONLY',
  'LEVEL_REQ',
...
export const SquadSessionStatusSchema = z.enum([
  'SCHEDULED',
  'ACTIVE',
  'PAUSED',
  'COMPLETED',
...
export const SquadChallengeTypeSchema = z.enum([
  'TOTAL_FOCUS_TIME',
  'SESSION_COUNT',
  'CONCURRENT_SESSIONS',
  'BOSS_DAMAGE',
...
export const SquadChallengeStatusSchema = z.enum([
  'PENDING',
  'ACTIVE',
  'COMPLETED',
  'FAILED',
...
export const SquadActivityTypeSchema = z.enum([
  'MEMBER_JOINED',
  'MEMBER_LEFT',
  'MEMBER_KICKED',
  'ROLE_CHANGED',
...
export const SynergyActivityTypeSchema = z.enum([
  'SESSION_COMPLETE',
  'SESSION_TOGETHER',
  'BOSS_DAMAGE',
  'CHALLENGE_PROGRESS',
...
export const SquadPermissionSchema = z.enum([
  'VIEW_SQUAD',
  'INVITE_MEMBERS',
  'KICK_MEMBERS',
  'MANAGE_ROLES',
...
export const SquadErrorCodeSchema = z.enum([
  'SQUAD_NOT_FOUND',
  'SQUAD_FULL',
  'ALREADY_MEMBER',
  'NOT_MEMBER',
...
export const SquadActivitySchema = z
  ...
  .strict();
export const SquadWarStatusSchema = z.enum([
  'active',
  'victory',
  'defeat',
  'expired',
...
export const InviteToSquadInputSchema = z
  ...
  .strict();
export const RespondToInviteInputSchema = z
  .object({ inviteId: z.string().uuid(), accept: z.boolean() })
  .strict();
...
export const StartSquadSessionInputSchema = z
  ...
  .strict();
export const JoinSquadSessionInputSchema = z
  .object({ sessionId: z.string().uuid(), userId: z.string().uuid() })
  .strict();
...
export type SquadJoinRequestDetail = z.infer<
  typeof SquadJoinRequestDetailSchema
>;
...
export type SquadSessionParticipant = z.infer<
  typeof SquadSessionParticipantSchema
>;
...
export type StartSquadSessionInput = z.infer<
  typeof StartSquadSessionInputSchema
>;
export type JoinSquadSessionInput = z.infer<typeof JoinSquadSessionInputSchema>;
export type RecordSquadWarDamageInput = z.infer<
  typeof RecordSquadWarDamageInputSchema
>;
