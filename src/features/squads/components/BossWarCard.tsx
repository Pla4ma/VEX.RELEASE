...
export function BossWarCard({
  ...
  onViewDetails,
  isLoading = false,
}: BossWarCardProps): JSX.Element | null {
        ...
        >
          ...
          <Box flexDirection="row" justifyContent="space-between" alignItems="center" mb="md">
            <Box flexDirection="row" alignItems="center" gap="sm">
              ...
              <Text
                variant="caption"
                color={isUrgent ? theme.colors.error.DEFAULT : theme.colors.text.secondary}
                fontWeight={isUrgent ? '600' : '400'}
              >
                {isUrgent ? '⏰ ' : ''}{formatTimeRemaining(hoursRemaining)}
              </Text>
            </Box>
          ...
          <Box flexDirection="row" alignItems="center" gap="md" mb="md">
            ...
            <Box alignItems="center">
              <Text
                variant="h3"
                color={bossHealthPercent < 25 ? theme.colors.error.DEFAULT : tierColor}
                fontWeight="800"
              >
