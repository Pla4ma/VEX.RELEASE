...
describe('Squads Service', () => {
  ...
  describe('createSquad', () => {
    ...
    it('should throw DUPLICATE_MEMBERSHIP if user already in squad', async () => {
      ...
      await expect(service.createSquad('user-1', {
        name: 'Test Squad',
        description: null,
        avatarUrl: null,
        isPublic: true,
  ...
  describe('inviteToSquad', () => {
    ...
    it('should throw SQUAD_FULL when squad is at capacity', async () => {
      ...
      await expect(service.inviteToSquad({
        squadId: 'squad-1',
        invitedUserId: 'user-2',
        roleOffered: 'MEMBER',
        message: null,
  ...
  describe('respondToInvite', () => {
    ...
    it('should throw INVITE_EXPIRED for expired invite', async () => {
      ...
      await expect(service.respondToInvite('user-2', { inviteId: 'invite-1', accept: true }))
  ...
  describe('leaveSquad', () => {
    ...
    it('should throw FOUNDER_TRANSFER_REQUIRED for founder without transfer', async () => {
      ...
      await expect(service.leaveSquad('user-1', { squadId: 'squad-1', newFounderId: null }))
        .rejects.toThrow('FOUNDER_TRANSFER_REQUIRED');
    });
  ...
  describe('kickMember', () => {
    ...
    it('should throw CANNOT_KICK_FOUNDER when trying to kick founder', async () => {
      ...
      await expect(service.kickMember('user-1', {
        squadId: 'squad-1',
        memberUserId: 'user-2',
        reason: 'Violation',
  ...
  describe('updateMemberRole', () => {
    ...
    it('should throw when trying to change founder role directly', async () => {
      ...
      await expect(service.updateMemberRole('user-1', {
        squadId: 'squad-1',
        memberUserId: 'user-2',
        newRole: 'ADMIN',
      })).rejects.toThrow();
