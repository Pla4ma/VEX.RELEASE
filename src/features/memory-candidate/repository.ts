...
export async function createMemoryCandidate(input: MemoryCandidateInput): Promise<MemoryCandidate> {
...
export async function deleteMemoryCandidate(userId: string, candidateId: string): Promise<void> {
