...
describe('Challenge Validation', () => {
  describe('validateChallengeCompletion', () => {
    it('should validate normal completion', () => {
      const result = validateChallengeCompletion(
        ...
        { id: 'challenge-1', difficulty: 'MEDIUM', expectedDuration: 300, minDuration: 60, maxDuration: 600 },
    ...
    it('should detect completion too fast', () => {
      const result = validateChallengeCompletion(
        ...
        { id: 'challenge-1', difficulty: 'HARD', expectedDuration: 300, minDuration: 60, maxDuration: 600 },
        { previousCompletions: [], avgTimeForDifficulty: 300 }
      );
    ...
    it('should detect excessive attempts', () => {
      const result = validateChallengeCompletion(
        ...
        { id: 'challenge-1', difficulty: 'EASY', expectedDuration: 300, minDuration: 60, maxDuration: 600 },
        { previousCompletions: [], avgTimeForDifficulty: 300 }
      );
  ...
  describe('analyzeChallengeBalance', () => {
    it('should validate balanced challenge', () => {
      const result = analyzeChallengeBalance(
        { completionRate: 0.7, avgTimeSpent: 280, avgAttempts: 2.5, abandonmentRate: 0.1 },
    ...
    it('should recommend adjustment for low success rate', () => {
      const result = analyzeChallengeBalance(
        { completionRate: 0.1, avgTimeSpent: 590, avgAttempts: 8, abandonmentRate: 0.5 },
        { targetCompletionRate: 0.65, targetTimeSpent: 300, maxAbandonmentRate: 0.2 }
      );
  ...
  describe('ChallengeCompletionSchema', () => {
    ...
    it('should reject negative timeSpent', () => {
      expect(() => ChallengeCompletionSchema.parse({
        challengeId: 'c1',
        userId: 'u1',
        completedAt: Date.now(),
        timeSpent: -10,
