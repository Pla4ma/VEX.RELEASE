 ...
 *
 * Comprehensive test suite for challenge service logic.
 */
...
describe('Challenges Service', () => {
  ...
  describe('assignChallenge', () => {
    it('should assign a challenge to a user', async () => {
      ...
      mockedRepository.createUserChallenge.mockResolvedValue(mockChallenge as any);
  ...
  describe('updateChallengeProgress', () => {
    it('should update progress and complete challenge', async () => {
      ...
      mockedRepository.fetchUserChallenge.mockResolvedValue(mockUserChallenge as any);
      mockedRepository.fetchChallengeById.mockResolvedValue(mockChallenge as any);
