...
export const NearMissIndicator: React.FC<NearMissIndicatorProps> = ({
  ...
  const getNearMissMessage = (progress: number): string => {
    if (progress >= 95) {return 'So close! Just a tiny bit more!';}
    if (progress >= 90) {return 'Almost had it! Next time for sure!';}
    if (progress >= 85) {return "Great effort! You're getting close!";}
    if (progress >= 80) {return 'Good progress! Keep pushing!';}
