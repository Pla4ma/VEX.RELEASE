...
export const VexActionResultSchema = z.object({
...
export const CompleteReflectionInputSchema = z.object({
  userId: z.string().min(1),
  lane: LaneSchema,
...
// 4. start_rescue
export const StartRescueInputSchema = z.object({
  userId: z.string().min(1),
  lane: LaneSchema,
...
export const ScheduleFocusWindowInputSchema = z.object({
  userId: z.string().min(1),
  lane: LaneSchema,
...
export const CreateStudyBlockInputSchema = z.object({
  userId: z.string().min(1),
...
export const UpdateProjectThreadInputSchema = z.object({
  userId: z.string().min(1),
...
export const ReadMemorySummaryInputSchema = z.object({
  userId: z.string().min(1),
...
export const UpdateLaneOverrideInputSchema = z.object({
  userId: z.string().min(1),
...
export const FocusSessionConfigOutputSchema = z.object({
...
export const ActionFeatureCheckSchema = z.object({
  allowed: z.boolean(),
...
export type CompleteReflectionInput = z.infer<typeof CompleteReflectionInputSchema>;
export type StartRescueInput = z.infer<typeof StartRescueInputSchema>;
export type ScheduleFocusWindowInput = z.infer<typeof ScheduleFocusWindowInputSchema>;
export type CreateStudyBlockInput = z.infer<typeof CreateStudyBlockInputSchema>;
export type UpdateProjectThreadInput = z.infer<typeof UpdateProjectThreadInputSchema>;
export type ReadMemorySummaryInput = z.infer<typeof ReadMemorySummaryInputSchema>;
export type UpdateLaneOverrideInput = z.infer<typeof UpdateLaneOverrideInputSchema>;
export type FocusSessionConfigOutput = z.infer<typeof FocusSessionConfigOutputSchema>;
