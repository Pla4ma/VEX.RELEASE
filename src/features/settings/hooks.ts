...
export function usePrivacySettings(
  userId: string,
  options?: Omit<UseQueryOptions<import('./types').PrivacySettings>, 'queryKey' | 'queryFn'>
) {
  return useQuery({
...
export function useUpdatePrivacySettings(
  userId: string,
  options?: Omit<
    UseMutationOptions<import('./types').PrivacySettings, Error, Partial<import('./types').PrivacySettings>>,
    'mutationFn'
  >
) {
  const queryClient = useQueryClient();
