...
const styles = createSheet({
  ...
  settingLabel: { fontSize: 16, color: launchColors.hex_374151 },
  ...
  settingArrow: { fontSize: 18, color: launchColors.hex_9ca3af },
  toggle: {
    width: 50,
    height: 28,
    borderRadius: 14,
  ...
  toggleActive: { backgroundColor: launchColors.hex_6366f1 },
  toggleKnob: {
    width: 24,
    height: 24,
    borderRadius: 12,
