import type { MotivationStyle, PrimaryGoal } from '../personalization/core-schemas';
...
export function addGoalScore(scores: LaneScores, goal: PrimaryGoal | null | undefined): void {
...
export function addStyleScore(scores: LaneScores, style: MotivationStyle | null | undefined): void {
...
export function makeEvidence(source: LaneEvidence['source'], value: string, weight: number, observedAt: number): LaneEvidence {
