...
export function CoachMessageBubble({
  ...
  return (
    ...
    >
      ...
      >
        <Text
          variant="body"
          color={isCoach ? theme.colors.text.primary : theme.colors.text.inverse}
        >
          {displayContent}
        </Text>
  ...
  accessibilityHint="Activates this control">
        ...
        <Text
          variant="caption"
          color={isCoach ? theme.colors.text.tertiary : `${theme.colors.text.inverse}80`}
          style={{ marginTop: theme.spacing[1] }}
        >
        ...
        {message.actionTaken && (
          ...
          accessibilityHint="Activates this control">
            <Text
              variant="bodySmall"
              color={isCoach ? theme.colors.text.inverse : theme.colors.text.primary}
              fontWeight="600"
            >
              {message.actionTaken}
            </Text>
