...
export function ErrorState({
  ...
  const handleRetry = async () => {
    if (!onRetry || localAttempts >= maxRetries) {return;}
...
export function ValidationErrorState({
  ...
  return (
    <ErrorState
      title="Invalid Input"
      message={field ? `Please check the ${field} field and try again.` : "Some of the information provided doesn't look right. Please review and try again."}
...
export function ErrorBoundaryFallback({
  ...
  return (
    <ErrorState
      ...
      message={error.message || 'An unexpected error occurred in the coach component.'}
