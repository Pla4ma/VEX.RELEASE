...
function getPersonalityName(personaId?: string | null): string {
  ...
  return (
    PERSONALITY_METADATA[personaId as keyof typeof PERSONALITY_METADATA]
      ?.name || "Coach"
  );
}
