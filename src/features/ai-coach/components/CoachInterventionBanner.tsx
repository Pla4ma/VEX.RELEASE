...
export function CoachInterventionBanner({
  ...
  const getIcon = (type: InterventionType): string => {
    switch (type) {
      ...
      case 'BOSS_FINISH': return '⚔️';
      case 'BOSS_OPPORTUNITY': return '🎯';
      case 'STUDY_BEHIND': return '📚';
      case 'MOMENTUM_BUILDING': return '📈';
      case 'COMEBACK_READY': return '🔄';
      case 'STUDY_PLAN_COMPLETE': return '🏆';
      default: return '💡';
    }
  };
        ...
        >
          ...
          {canDismiss && (
            ...
            accessibilityHint="Activates this control">
              <Text fontSize={18} color="secondary">×</Text>
            </Pressable>
          )}
        </View>
