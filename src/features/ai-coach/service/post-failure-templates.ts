...
export const DAY2_GOAL_TEMPLATES: Record<CoachStyle, string[]> = {
  ...
  CHEERLEADER: [
    "Day 2 of your comeback. Let's make it small and easy — just 15 minutes. You can totally do that. I believe in you.",
    "Fifteen minutes. That's like nothing. You got this. Start small, end strong.",
  ],
  RIVAL: [
...
export const DAY3_MOMENTUM_TEMPLATES: Record<CoachStyle, string[]> = {
  ...
  CHEERLEADER: [
    "DAY 3. You're doing great. Let's do 20 minutes today and keep this amazing momentum going. You are back.",
