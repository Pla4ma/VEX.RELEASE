...
async function fetchTemplatesWithCache(
  ...
  // Check cache
  if (templateCache.templates.has(category) &&
...
function calculatePriority(
  ...
  if (context.urgency === 'high') {priority += 2;}
  if (context.urgency === 'critical') {priority += 3;}
  if (context.riskLevel === 'CRITICAL') {priority += 2;}
