...
} from "../../features/ai-coach/message-quality-gate";
...
describe("Quality Gate Integration", () => {
  describe("validateMessageQuality", () => {
    ...
    it("detects all six quality elements", () => {
      const fullMessage =
        "Your 7-day streak shows consistency. A 25-minute Recovery session tonight will protect it. Based on your patterns, now is optimal. I'm 85% confident this will work. Start the session now.";
      const result = validateMessageQuality(
        "full-msg",
        fullMessage,
        "STREAK_RISK",
      ...
      expect(result.qualityElements).toContain(
