...
jest.mock('../repository/memories', () => ({
  ...
  getMemoriesByUser: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
  getMemoriesByType: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
  markMemoryReferenced: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
  getMostRecentMemoryByType: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
  hasMemoryOfType: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
  getMemoriesByTypes: jest.fn().mockRejectedValue(new Error('Supabase unavailable')),
