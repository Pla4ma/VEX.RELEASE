        ...
        >
          ...
          <Box flexDirection="row" alignItems="center" gap="md" mb="md">
            ...
            <Box
              ...
              borderColor={showFinalStrike ? theme.colors.error[500] : theme.colors.border.DEFAULT}
            >
            ...
            >
              ...
              <Pressable
                ...
                disabled={
                  ...
                  (activeBountyCount !== undefined && activeBountyCount >= maxBounties)
                }
                style={{
