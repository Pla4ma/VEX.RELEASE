...
function TierBadge({
  ...
  tier: BossPreviewCardProps["tier"];
}): JSX.Element {
  const { theme } = useTheme();
    ...
    switch (tier) {
      case "LEGENDARY":
        return {
          ...
          bg: launchColors.rgb_245_158_11_0_2,
          label: "LEGENDARY",
        };
      case "EPIC":
        return {
          color: launchColors.hex_a855f7,
          bg: launchColors.rgb_168_85_247_0_2,
          label: "EPIC",
        };
      case "RARE":
        return {
          color: launchColors.hex_3b82f6,
          bg: launchColors.rgb_59_130_246_0_2,
          label: "RARE",
        };
      case "UNCOMMON":
        return {
          color: launchColors.hex_22c55e,
          bg: launchColors.rgb_34_197_94_0_2,
          label: "UNCOMMON",
        };
      default:
        return {
