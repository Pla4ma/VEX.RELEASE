 ...
 */
function getUrgencyMessage(hoursRemaining: number | null, streakDays: number): {
  headline: string;
  subtext: string;
        ...
        >
          <Box flexDirection="row" alignItems="center" gap="md">
            <Box
              ...
              height={40}
              borderRadius="full"
              bg={isCritical ? `${theme.colors.error.dark}40` : `${theme.colors.warning.dark}40`}
            ...
            <Box flex={1}>
              ...
              <Text
                variant="caption"
                color={isCritical || isUrgent ? `${textColor}90` : theme.colors.text.secondary}
              >
                {subtext}
              </Text>
            </Box>
            ...
            <Box
              ...
              py="xs"
              borderRadius="md"
              bg={isCritical ? theme.colors.error.dark : theme.colors.background.primary}
            >
              <Text
                variant="caption"
                color={isCritical ? theme.colors.text.inverse : theme.colors.primary[500]}
                fontWeight="700"
              >
                START →
              </Text>
