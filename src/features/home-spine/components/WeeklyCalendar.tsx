 ...
 *
 * 7-day strip on home screen showing:
 * - Completed sessions (checkmark)
 * - Bonus events (icons)
 * - Challenge expiry
 * - Today highlighted
 * - Popover on tap showing day details
 *
 * @phase 5A.1
 */
...
function DayCell({
  ...
  accessibilityHint="Activates this control">
        ...
        >
          ...
          <Text
            variant="caption"
            color={isSelected ? 'text.inverse' : isToday ? 'primary.500' : 'text.tertiary'}
  ...
  accessibilityHint="Activates this control">
      ...
      <Box mb="md">
        ...
        <Box flexDirection="row" alignItems="center" gap="sm">
          <Text fontSize={24}>
            {day.status === 'completed' ? '✅' : day.status === 'partial' ? '◐' : day.status === 'missed' ? '❌' : '📅'}
          </Text>
