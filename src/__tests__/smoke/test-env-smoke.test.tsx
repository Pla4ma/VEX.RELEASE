...
jest.mock('react-native-purchases', () => ({
  ...
  default: {
    configure: jest.fn(),
    setLogLevel: jest.fn(),
    getCustomerInfo: jest.fn(() => Promise.resolve({ entitlements: { all: {}, active: {} } })),
    getOfferings: jest.fn(() => Promise.resolve({ current: null, all: {} })),
    purchasePackage: jest.fn(() => Promise.resolve({ customerInfo: { entitlements: { all: {}, active: {} } } })),
    restorePurchases: jest.fn(() => Promise.resolve({ customerInfo: { entitlements: { all: {}, active: {} } } })),
    logIn: jest.fn(() => Promise.resolve({ customerInfo: { entitlements: { all: {}, active: {} } } })),
    logOut: jest.fn(() => Promise.resolve({ customerInfo: { entitlements: { all: {}, active: {} } } })),
...
describe('Test environment smoke', () => {
  ...
  it('renders VEX primitive component (Badge)', () => {
    ...
    const { getByText } = render(
      <Badge variant="primary">VEX Smoke</Badge>
    );
