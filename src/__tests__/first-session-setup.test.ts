import { experience, firstWeek, accessFor, assertFullyHidden } from './debloat-test-helpers';
...
describe('Group 2 — First Session Setup', () => {
  it('2a: first session setup shows only mode/duration/start', () => {
    ...
    expect(getFeatureAvailability(f0.focus_session).canRenderEntryPoint).toBe(true);
