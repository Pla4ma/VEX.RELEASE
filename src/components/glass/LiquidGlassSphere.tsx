...
import { COLOR_CONFIGS } from './LiquidGlassSphere.tokens';
    ...
    >
      <Svg height={size} viewBox={`0 0 ${size} ${size}`} width={size}>
        ...
        <G>
          ...
          <Ellipse cx={center} cy={center + r * 0.72} fill={`url(#shadow-${color})`} rx={r * 0.72} ry={r * 0.22} />
          <Circle cx={center} cy={center} fill={`url(#shell-outer-${color})`} r={r} />
          <Circle cx={center} cy={center} fill="none" r={r} stroke={`url(#rim-light-${color})`} strokeWidth={size * 0.025} />
          <Circle cx={center} cy={center} fill={`url(#refract-${color})`} r={r} />
          <Circle cx={center} cy={center} fill={`url(#liquid-${color})`} r={r * 0.88} />
          <Circle cx={center} cy={center} fill={`url(#liquid-deep-${color})`} r={r * 0.88} />
          <Path
          ...
          />
          <Circle cx={center + r * 0.22} cy={center - r * 0.28} fill={`url(#specular2-${color})`} r={r * 0.15} />
