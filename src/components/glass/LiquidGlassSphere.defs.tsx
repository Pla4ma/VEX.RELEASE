  ...
  return (
    <Defs>
      ...
      <RadialGradient cx="50%" cy="85%" id={`shadow-${color}`} r="40%">
        <Stop offset="0%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity={0.22 * i} />
        <Stop offset="50%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity={0.08 * i} />
      ...
      <RadialGradient cx="45%" cy="40%" id={`shell-outer-${color}`} r="55%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.85} />
        <Stop offset="30%" stopColor="#E8FFF6" stopOpacity={0.55} />
        <Stop offset="60%" stopColor="theme.glassColors.vexCyanSoft" stopOpacity={0.35} />
      ...
      <RadialGradient cx="32%" cy="28%" id={`specular-${color}`} r="30%">
        ...
        <Stop offset="25%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.82} />
        <Stop offset="55%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.38} />
        <Stop offset="100%" stopColor="theme.glassColors.vexWhite" stopOpacity={0} />
      </RadialGradient>
      <RadialGradient cx="65%" cy="22%" id={`specular2-${color}`} r="20%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.72} />
        <Stop offset="40%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.32} />
        <Stop offset="100%" stopColor="theme.glassColors.vexWhite" stopOpacity={0} />
      </RadialGradient>
      <LinearGradient id={`rim-light-${color}`} x1="0" x2="0.5" y1="0" y2="0.5">
        ...
        <Stop offset="40%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.45} />
        <Stop offset="100%" stopColor="theme.glassColors.vexWhite" stopOpacity={0} />
      </LinearGradient>
      ...
      <RadialGradient cx="50%" cy="50%" id={`refract-${color}`} r="48%">
        <Stop offset="85%" stopColor="theme.glassColors.vexWhite" stopOpacity={0} />
        <Stop offset="92%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.22} />
        <Stop offset="96%" stopColor="theme.glassColors.vexWhite" stopOpacity={0.12} />
        <Stop offset="100%" stopColor={c.rim} stopOpacity={0.32} />
      </RadialGradient>
      <Mask id={`mask-${color}`}>
        <Circle cx={s} cy={s} fill="theme.glassColors.vexWhite" r={s * 0.46 * 0.88} />
      </Mask>
    </Defs>
  );
}
