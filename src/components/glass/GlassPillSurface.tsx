...
const TONE_CONFIG: Record<GlassPillTone, ToneConfig> = {
  neutral: {
    ...
    shadowRadius: 8,
    elevation: 2,
    gradientTop: 'rgba(255, 255, 255, 0.55)',
    gradientBottom: 'rgba(255, 255, 255, 0.30)',
  },
  mint: {
    fill: 'rgba(95, 230, 197, 0.22)',
    border: 'rgba(66, 207, 174, 0.65)',
    highlight: 'rgba(255, 255, 255, 0.55)',
    shadowColor: 'rgba(18, 184, 148, 0.28)',
    shadowOpacity: 0.22,
    shadowRadius: 10,
    elevation: 3,
    gradientTop: 'rgba(95, 230, 197, 0.35)',
    gradientBottom: 'rgba(66, 207, 174, 0.15)',
  },
  fire: {
  ...
  premium: {
    fill: 'rgba(121, 223, 201, 0.22)',
    border: 'rgba(121, 223, 201, 0.70)',
    highlight: 'rgba(255, 255, 255, 0.50)',
    shadowColor: 'rgba(18, 184, 148, 0.28)',
    shadowOpacity: 0.24,
    shadowRadius: 12,
    elevation: 3,
    gradientTop: 'rgba(121, 223, 201, 0.35)',
    gradientBottom: 'rgba(66, 207, 174, 0.15)',
  },
};
