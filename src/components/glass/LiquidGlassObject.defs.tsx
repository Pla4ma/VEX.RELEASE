  ...
  return (
    <Defs>
      <RadialGradient cx="42%" cy="38%" id="liquidCore" r="65%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.98" />
        <Stop offset="18%" stopColor="theme.glassColors.vexOffWhite" stopOpacity="0.94" />
        <Stop offset="38%" stopColor="theme.glassColors.vexCyanSoft" stopOpacity="0.78" />
      ...
      <LinearGradient id="rimLight" x1="0" x2="1" y1="0" y2="1">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.95" />
        ...
        <Stop offset="100%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity="0.85" />
      </LinearGradient>

      <RadialGradient cx="48%" cy="45%" id="innerDistortion" r="50%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.55" />
      ...
      <RadialGradient cx="32%" cy="28%" id="specularHot" r="28%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="1" />
        <Stop offset="30%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.78" />
        <Stop offset="65%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.32" />
        <Stop offset="100%" stopColor="theme.glassColors.vexWhite" stopOpacity="0" />
      </RadialGradient>

      <RadialGradient cx="65%" cy="22%" id="specularSecondary" r="18%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.82" />
        <Stop offset="50%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.38" />
        <Stop offset="100%" stopColor="theme.glassColors.vexWhite" stopOpacity="0" />
      </RadialGradient>

      <RadialGradient cx="50%" cy="85%" id="contactShadow" r="35%">
        <Stop offset="0%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity="0.22" />
        <Stop offset="50%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity="0.08" />
        <Stop offset="100%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity="0" />
      </RadialGradient>

      <LinearGradient id="edgeBevel" x1="0" x2="1" y1="0" y2="1">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.92" />
        <Stop offset="40%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.18" />
        <Stop offset="60%" stopColor="#0A9B8A" stopOpacity="0.12" />
        <Stop offset="100%" stopColor="theme.glassColors.vexDeepTeal" stopOpacity="0.55" />
      </LinearGradient>
      ...
      <RadialGradient cx="45%" cy="40%" id="lensBody" r="55%">
        <Stop offset="0%" stopColor="theme.glassColors.vexWhite" stopOpacity="0.92" />
        <Stop offset="25%" stopColor="theme.glassColors.vexOffWhite" stopOpacity="0.78" />
        <Stop offset="55%" stopColor="theme.glassColors.vexCyanSoft" stopOpacity="0.52" />
