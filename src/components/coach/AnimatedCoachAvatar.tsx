...
export function AnimatedCoachAvatar({
  ...
  return (
    <View
      ...
      style={[{ height: size, width: size, alignItems: 'center', justifyContent: 'center' }, style]}
    >
      <Animated.View
        style={[
          {
        ...
        <Svg height={size} width={size} viewBox="0 0 120 120">
          <Defs>
            <LinearGradient id="coachBody" x1="18" y1="8" x2="104" y2="112">
              <Stop offset="0" stopColor={theme.colors.semantic.accent} stopOpacity="1" />
              <Stop offset="0.52" stopColor={theme.colors.semantic.primary} stopOpacity="1" />
              <Stop offset="1" stopColor={theme.colors.semantic.surfaceElevated} stopOpacity="1" />
            </LinearGradient>
            <LinearGradient id="coachFace" x1="31" y1="30" x2="90" y2="88">
              <Stop offset="0" stopColor={theme.colors.semantic.textPrimary} stopOpacity="0.98" />
              <Stop offset="1" stopColor={theme.colors.semantic.textSecondary} stopOpacity="0.82" />
            </LinearGradient>
          </Defs>
          <Ellipse cx="60" cy="107" rx="32" ry="7" fill={theme.colors.semantic.shadow} opacity="0.28" />
          <Path
          ...
          <Path
            d={mood === 'celebrate' ? 'M48 73c7 7 17 7 24 0' : 'M50 73c6 4 14 4 20 0'}
            stroke={theme.colors.semantic.textPrimary}
            strokeLinecap="round"
            strokeWidth="4"
          />
          <Circle cx="22" cy="54" r="7" fill={theme.colors.semantic.accent} opacity="0.9" />
          <Circle cx="98" cy="54" r="7" fill={theme.colors.semantic.secondary} opacity="0.9" />
          <Path
