...
export const routeParamSchemas = {
  ActiveSession: z
    .object({ sessionId: uuidish, selectedThemeId: optionalShortText })
    .strict(),
  ...
  MonthlyFocusReport: z
    ...
    .optional(),
  Onboarding: z
    .object({ step: z.number().int().nonnegative().optional() })
    .strict(),
  Paywall: z
    .object({
  ...
  VipPaywall: z
    .object({
      source: optionalShortText,
      gemCount: z.number().nonnegative().optional(),
    })
    .strict(),
} as const;
