...
export const MidSessionBossTauntsSchema = z.object({
  spawn: z.string().min(1).optional(),
  halfHealth: z.string().min(1).optional(),
  nearDeath: z.string().min(1).optional(),
}).strict();

export const EvaluateMidSessionEventInputSchema = z.object({
...
export const MidSessionEventSchema = z.object({
  key: z.string().min(1),
...
export type EvaluateMidSessionEventInput = z.infer<typeof EvaluateMidSessionEventInputSchema>;
