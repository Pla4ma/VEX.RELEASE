...
export const RewardLedgerSchema = z
  ...
  .strict();
export const RewardMultiplierSchema = z.object({ source: z.string(), value: z.number(), description: z.string() }).strict();
export const RewardBonusSchema = z.object({ source: z.string(), amount: z.number(), description: z.string() }).strict();
...
export const CreateRewardInputSchema = z
  ...
  .strict();
export const ClaimRewardInputSchema = z.object({ rewardId: z.string().uuid(), userId: z.string().uuid() }).strict();
