...
export function CreativeMoodLogger({ isVisible, onMoodSelected, onSkip }: CreativeMoodLoggerProps): JSX.Element | null {
  ...
  return (
    ...
    >
        ...
        {MOODS.map((mood) => (
          <Pressable
            ...
            style={{
              ...
              backgroundColor: selected?.emoji === mood.emoji
                ? theme.colors.primary[500] + '30'
                : theme.colors.background.tertiary,
              borderWidth: 1,
              borderColor: selected?.emoji === mood.emoji
          ...
          >
            ...
            <Text variant="caption" color="text.secondary">{mood.label}</Text>
          </Pressable>
        ))}
      </Box>
      ...
      <Pressable
        ...
        accessibilityRole="button"
      >
        <Text variant="caption" color="text.tertiary">Skip</Text>
      </Pressable>
    </Animated.View>
  );
}
