...
export const FOCUS_TECHNIQUES: Record<FocusTechnique, FocusTechniqueConfig> = {
  POMODORO: {
    id: 'POMODORO',
    name: 'Pomodoro',
    description: '25 minutes of focus, 5 minute break. Classic time management.',
    duration: 25 * 60,
    breakDuration: 5 * 60,
  ...
  FLOWTIME: {
    id: 'FLOWTIME',
    name: 'Flowtime',
    description: 'Flexible duration based on your natural flow. Break when needed.',
    duration: 45 * 60,
    breakDuration: 10 * 60,
  ...
  ULTRADIAN: {
    id: 'ULTRADIAN',
    name: '52/17 Rule',
    description: '52 minutes focus, 17 minute break. Matches natural ultradian rhythms.',
    duration: 52 * 60,
    breakDuration: 17 * 60,
    longBreakDuration: 30 * 60,
    intervals: 4,
  ...
  DEEP_WORK: {
    id: 'DEEP_WORK',
    name: 'Deep Work',
    description: '90 minutes of uninterrupted focus. For complex cognitive tasks.',
    duration: 90 * 60,
    breakDuration: 20 * 60,
 ...
 */
export function getTechniqueConfig(technique: FocusTechnique): FocusTechniqueConfig {
 ...
 */
export function getTechniquesForActivity(activity: string): FocusTechniqueConfig[] {
