-- T1-4: Cap finalScore and modeBonus in complete_session RPC to prevent reward inflation
-- Uses LEAST() clamp at top of validation block; IF NOT EXISTS guard
-- Migration: 20260605_session_complete_caps.sql
