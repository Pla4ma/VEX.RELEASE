 ...
 * Register Screen
 *
 * Premium user registration screen with FormField components and inline validation.
 */
...
export const RegisterScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleBlur = useCallback(
    ...
    [email, validateEmail, validatePasswordMatch]
  );
  ...
  const handleRegister = useCallback(async () => {
    ...
    const formData: RegisterFormData & { agreeToTerms: boolean } = {
      firstName,
      lastName,
      email,
      password,
        ...
        <Box flex={1} justifyContent="center" px="xl" py="2xl">
          ...
          <Animated.View entering={FadeInDown.delay(300).duration(600)}>
            <FormField
              ...
              helperText="Use 8+ characters with a number"
              returnKeyType="next"
              containerStyle={{ marginTop: 12 }}
            />
          </Animated.View>
            ...
            accessibilityHint="Activates this control">
              <View
                style={{
                  ...
                  borderRadius: 6,
                  borderWidth: 2,
                  borderColor: agreeToTerms ? theme.colors.primary[500] : theme.colors.border.DEFAULT,
                  backgroundColor: agreeToTerms ? theme.colors.primary[500] : 'transparent',
