...
import type { FocusContract, ReflectionStatus } from '../../../features/focus-contract/types';
...
const options: Array<{ status: ReflectionStatus; label: string; hint: string }> = [
  { status: 'done', label: 'Done', hint: 'Marks your focus contract as completed' },
  { status: 'partial', label: 'Partial', hint: 'Marks your focus contract as partly completed' },
  { status: 'not_done', label: 'Not this time', hint: 'Marks your focus contract as not completed' },
];
...
export function SessionContractReflectionCard({
  ...
  return (
    <Box mx="lg" mb="md" bg="background.elevated" borderRadius={theme.borderRadius.lg} p="lg">
