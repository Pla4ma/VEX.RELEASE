        ...
        <Animated.View entering={FadeInUp.delay(1000)}>
          <Box gap="md">
            ...
            {gemBalance < restoreCost && <Text variant="caption"color="text.tertiary"textAlign="center">
                ...
                {'\n'}
                <Text variant="caption"color="primary.500"onPress={()=>{const canGo = getFeatureAvailability(disclosure.features.shop).canNavigate; if(canGo)navigation.navigate('Shop');}}>
