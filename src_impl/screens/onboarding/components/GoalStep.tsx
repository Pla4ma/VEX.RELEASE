  ...
  return (
    <View style={styles.section}>
      ...
      <Text style={[styles.stepSubtitle, { color: theme.colors.text.secondary }]}>
        VEX gets useful after a real focus block. This choice tunes the first recommendation.
      </Text>
          ...
          return (
            <Pressable
              ...
              style={[
                styles.choiceCard,
                {
                  backgroundColor: isSelected ? `${theme.colors.primary[500]}18` : theme.colors.background.secondary,
