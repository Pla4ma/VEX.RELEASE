/**
 * OnboardingPermissions Component
 *
 * Push notification permission request.
 * Framed as game mechanics: streak alerts, boss spawns, squad challenges.
 * Never blocks - user can proceed regardless of permission.
 *
 * @phase 2.6
 */
