 ...
 *
 * Phase 14 - Account management screen.
 *
 * Features:
 * - Change password
        ...
        [
          { text: 'Cancel', style: 'cancel' },
          {
            ...
            onPress: () => {
              ...
              showToast({
                message: '2FA enabled. Please set up in your authenticator app.',
                type: 'success',
                duration: 5000,
              });
            },
            ...
            accessibilityHint="Activates this control">
              ...
              >
                <Icon
                  name="shield"
                  size={20}
                  color={twoFactorEnabled ? theme.colors.success.DEFAULT : theme.colors.text.tertiary}
                />
              </Box>
          ...
          <Card size="sm" style={{ overflow: 'hidden' }}>
            {!showPasswordFields ? (
              ...
              <Box p={16}>
                <Text
                  variant="body"
                  style={{ fontWeight: '600', marginBottom: 16, color: theme.colors.text.primary }}
                >
                  Change Password
                </Text>
