 ...
 *
 * Phase 14.2 - Complete notification preferences with quiet hours.
 *
 * Features:
...
export const NotificationSettingsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleSetQuietHours = useCallback((type: 'start' | 'end') => {
    ...
    // For now, we show an alert with preset times
    Alert.alert(
  ...
  const notificationGroups: { title: string; items: NotificationToggle[] }[] = [
    {
      ...
      items: [
        {
          ...
          enabled: toggles.streakReminders,
        },
        {
          id: 'sessionReminders',
          icon: 'clock',
          title: 'Session Reminders',
          description: 'Daily prompts to start a focus session',
      ...
      items: [
        {
          ...
          icon: 'target',
          title: 'Boss Alerts',
          description: 'Boss spawn, timeout warnings, and defeat',
          enabled: toggles.bossAlerts,
        },
        {
          id: 'squadNotifications',
          icon: 'users',
          title: 'Squad Activity',
          description: 'Squad invites, wars, and member activity',
          enabled: toggles.squadNotifications,
        },
        {
          id: 'rivalNotifications',
          icon: 'zap',
          title: 'Rival Challenges',
          description: 'New challenges and duel results',
          enabled: toggles.rivalNotifications,
        },
        {
          id: 'dailyChallenge',
          icon: 'calendar',
          title: 'Daily Challenges',
          description: 'New challenges and completion reminders',
          enabled: toggles.dailyChallenge,
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          enabled: toggles.achievementUnlocks,
        },
        {
          id: 'coachMessages',
          icon: 'message-circle',
          title: 'AI Coach Messages',
          description: 'Tips, encouragement, and insights',
          enabled: toggles.coachMessages,
        },
        {
          id: 'weeklyReport',
          icon: 'bar-chart-2',
  ...
  const renderToggleItem = (item: NotificationToggle) => {
    const iconColor = toggles[item.id]
    ...
    return (
      ...
      accessibilityHint="Activates this control">
        ...
        <Switch
          ...
          thumbColor={toggles[item.id] ? theme.colors.primary[500] : '#FFF'}
        />
      </Pressable>
    );
  };
            ...
            accessibilityHint="Activates this control">
              ...
              >
                <Icon
                  name="moon"
                  size={20}
                  color={quietHours.enabled ? theme.colors.primary[500] : theme.colors.text.tertiary}
                />
              </Box>
              ...
              <Switch
                ...
                thumbColor={quietHours.enabled ? theme.colors.primary[500] : '#FFF'}
              />
            </Pressable>
