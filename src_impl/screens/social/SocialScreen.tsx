...
const emptyWeeklyStats = { totalSessions: 0, totalFocusMinutes: 0, activeMemberCount: 0 };
...
export function SocialScreen(): JSX.Element {
  ...
  return (
    <>
      ...
      >
        <View style={{ gap: theme.spacing[2] }}>
          ...
          <Text variant="body" color={theme.colors.text.secondary}>
            Social in VEX is here to reinforce your focus habit: squad progress,
            leaderboard pressure, and one clear reason to show up.
          </Text>
        </View>
        ...
        {!primarySquad && !squadsQuery.isLoading ? (
          <>
            ...
            >
              ...
              <Text variant="bodySmall" color={theme.colors.text.secondary}>
                Create a squad when you want visible team momentum, weekly
                pressure, and a shared reason to keep your streak alive.
              </Text>
              <Button
        ...
        {primarySquad ? (
          <>
            ...
            >
              ...
              {!weeklyStatsQuery.isLoading && !(weeklyStatsQuery.error instanceof Error) ? (
                <View style={{ gap: theme.spacing[2] }}>
                  ...
                  {weeklyStats.activeMemberCount === 0 ? (
                    <Text variant="bodySmall" color={theme.colors.text.secondary}>
                      No one has logged a session yet this week. Be the one who
                      starts the push.
                    </Text>
                  ) : null}
                </View>
              ...
              >
                <Button
                  variant="outline"
                  onPress={() => {
                    if (!canNavigateSquads) {
                      navigation.navigate('Main', { screen: 'Home' });
                      return;
                    }
                    navigation.navigate('Guild', { guildId: primarySquad.id });
                  }}
            ...
            {activeBossQuery.data && canNavigateBoss ? (
              <Pressable
            ...
            >
              ...
              <Text variant="bodySmall" color={theme.colors.text.secondary}>
                Detailed feed and deeper competitive modes are still here, but
                your main job is simpler: keep your squad moving.
              </Text>
              <Text
                variant="bodySmall"
                ...
                style={{ marginTop: 8 }}
              >
                Feed feature removed for simplified launch. Focus on your squad
                missions.
              </Text>
            </View>
          </>
      ...
      />
      {userId ? (
        <CreateSquadFlow bottomSheetRef={createSheetRef} userId={userId} />
      ) : null}
    </>
  );
}

export default withScreenErrorBoundary(SocialScreen, 'Social');
