...
import { StreakFuneralScreen, calculateRestoreCost, RESTORE_COSTS } from '../streaks/StreakFuneralScreen';
...
describe('StreakFuneralScreen', () => {
  ...
  it('shows context message about not letting one missed day erase the streak', () => {
    ...
    expect(getByText(/days of focus. Don't let one missed day erase it./)).toBeTruthy();
  });
