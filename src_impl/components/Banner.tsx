  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        {icon && (
          <View style={[styles.iconContainer, { marginRight: currentSize.padding }]}>
        ...
        <View style={styles.textContainer}>
          ...
          {(actionText || secondaryActionText) && (
            <View style={styles.actions}>
              {actionText && onAction && (
                <Button variant={variantStyles.buttonVariant} size="sm" onPress={onAction} style={{ marginRight: secondaryActionText ? 8 : 0 }} accessibilityLabel="Action button" accessibilityRole="button" accessibilityHint="Activates this control">
                  {actionText}
                </Button>
              )}
              {secondaryActionText && onSecondaryAction && (
                <Button variant="ghost" size="sm" onPress={onSecondaryAction} accessibilityLabel="Action button" accessibilityRole="button" accessibilityHint="Activates this control">
                  {secondaryActionText}
                </Button>
              )}
            </View>
        ...
        {onDismiss && (
          <Pressable onPress={onDismiss} style={({ pressed }) => [styles.dismissButton, pressed && { opacity: 0.7 }]} accessibilityLabel="Interactive control" accessibilityRole="button" accessibilityHint="Activates this control">
