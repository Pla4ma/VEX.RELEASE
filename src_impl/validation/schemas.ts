...
export const userProfileSchema = z.object({
  ...
  website: z.string().url('Please enter a valid URL').max(200, 'URL must be less than 200 characters').optional().or(z.literal('')),
});
...
export function validate<T>(
  ...
  data: unknown,
): { data?: T; errors?: z.ZodError['formErrors']['fieldErrors']; success: boolean } {
