  ...
  useTheme: () => ({
    theme: {
      colors: {
        ...
        text: { primary: 'theme.colors.primary[500]', secondary: 'theme.colors.primary[500]' },
        ...
        semantic: {
          ...
          surfaceElevated: 'theme.colors.background.primary',
          textPrimary: 'theme.colors.primary[500]',
          textSecondary: 'theme.colors.primary[500]',
        },
      },
...
function expectRenderedText(renderer: ReactTestRenderer, text: string): void {
  expect(renderer.root.findAllByProps({ children: text }).length).toBeGreaterThan(0);
}
