...
export interface RewardEventDefinitions {
  ...
  'rewards:coin_reward_queued': { userId: string; amount: number; warId: string };
  'rewards:badge_reward_queued': { userId: string; badgeId: string; warId: string };
  'rewards:title_reward_queued': { userId: string; titleId: string; warId: string };
