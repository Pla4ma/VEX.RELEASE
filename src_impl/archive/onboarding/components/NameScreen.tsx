 ...
 * Single input field. Continue enables when 2+ chars entered.
 * Keyboard auto-focuses on mount.
 *
 * @phase 2.5
 */
    ...
    <Box flex={1} bg="background.primary" px="lg" py="xl">
      ...
      >
        ...
        <Box mt="sm" alignItems="center">
          <Text
            variant="caption"
            color={name.length > 0 && !isValid ? 'error.DEFAULT' : 'text.tertiary'}
          >
      ...
      {/* Avatar preview (if name entered) */}
      {isValid && (
        <Animated.View
