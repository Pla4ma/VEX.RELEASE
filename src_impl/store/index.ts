          ...
          try {
            ...
            if (user) {
              ...
              try {
                ...
                debug.error(
                  '[AuthStore] Failed to set RevenueCat user ID during checkAuth:',
                  revenueCatError,
                );
              }
              if (!integrationsInitialized) {
              ...
              try {
                ...
                debug.error(
                  '[AuthStore] Failed to clear RevenueCat user ID during checkAuth:',
                  revenueCatError,
                );
              }
            }
...
export function useStore() {
  return { auth: useAuthStore(), app: useAppStore(), ui: useUIStore() };
}
