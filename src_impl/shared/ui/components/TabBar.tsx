    ...
    <View style={[styles.container, style]}>
      {scrollable ? (
        <ScrollView
          ...
          style={[styles.tabsContainer, isHorizontal ? styles.horizontal : styles.vertical]}
        ...
        <View style={[styles.tabsContainer, isHorizontal ? styles.horizontal : styles.vertical]}>
          {renderedTabs}
        </View>
      )}
    </View>
    ...
    <View style={[styles.breadcrumb, style]}>
      {items.map((item, index) => (
        <React.Fragment key={`${item.label}-${index}`}>
          {index > 0 ? (
            <Text variant="caption" color="text.tertiary" style={styles.separator}>
              {separator}
            </Text>
          ) : null}

          <Pressable onPress={item.onPress} disabled={!item.onPress || index === items.length - 1}
  ...
  accessibilityHint="Activates this control">
            <Text
              ...
              style={[
                ...
                index === items.length - 1 ? styles.breadcrumbItemActive : undefined,
              ]}
            >
              {item.label}
            </Text>
