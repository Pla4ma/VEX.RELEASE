...
const LoadingOverlay: React.FC<{ message?: string; theme: DynamicValue }> = ({
  message,
  theme,
}) => (
...
const DisabledOverlay: React.FC<{ reason?: string; theme: DynamicValue }> = ({
  reason,
  theme,
}) => (
  <View style={[styles.overlay, { backgroundColor: theme.colors.background.overlay }]}>
...
const ErrorOverlay: React.FC<{ message?: string; onRetry?: () => void; theme: DynamicValue }> = ({
  message,
  onRetry,
  theme,
}) => (
...
const SelectedOverlay: React.FC<{ icon?: string; theme: DynamicValue }> = ({
  icon = 'check-circle',
  theme,
}) => (
