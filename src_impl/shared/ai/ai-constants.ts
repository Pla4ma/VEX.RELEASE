/**
 * AI Constants - Server-Side Gemini Integration
 *
 * Centralized configuration for AI operations.
 * No API keys here - they live in .env.server only.
 *
 * All prompts are defined here to ensure consistency and prevent prompt injection.
 */
 ...
 * PRO for complex generation tasks
 */
