...
/**
 * Base AI request from client to backend
 * Backend validates this and constructs the actual Gemini prompt
 */
...
/**
 * AI response from backend to client
 * Fully validated and typed - no raw model output
 */
 ...
 * Client sends context, backend builds prompt
 */
