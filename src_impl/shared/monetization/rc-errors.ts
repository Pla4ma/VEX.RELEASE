/**
 * RevenueCat Error Utilities
 * Pure functions for error normalization and classification.
 */

import { PURCHASES_ERROR_CODE } from 'react-native-purchases';
import type { RevenueCatError, RevenueCatErrorCode } from './revenuecat-types';

// ============================================================================
// Types
// ============================================================================

export interface PurchasesErrorShape {
...
export function mapErrorCode(code: PURCHASES_ERROR_CODE): RevenueCatErrorCode {
  switch (code) {
