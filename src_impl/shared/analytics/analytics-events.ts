 ...
 * Analytics Events
 *
 * All event names defined as constants for strict typing and consistency.
 * Grouped by feature domain.
 *
 * Rules:
 * - Use snake_case naming
 * - Event names must be constants (no inline strings)
...
export type ProgressionEvent = typeof ProgressionEvents[keyof typeof ProgressionEvents];
...
export type PurchaseFunnelEvent = typeof PurchaseFunnelEvents[keyof typeof PurchaseFunnelEvents];
...
export type RetentionEvent = typeof RetentionEvents[keyof typeof RetentionEvents];
...
export interface BaseEventProperties {
  ...
  app_version?: string;
  // Network/Banner properties
  is_connected?: boolean;
  connection_type?: string;
  banner_type?: string;
  duration_until_reappear_sec?: number;
  reason?: string;
  // Additional properties used across events
...
export interface SocialEventProperties extends BaseEventProperties {
  ...
  // Phase 21 - Duel matchmaking properties
  duel_id?: string;
