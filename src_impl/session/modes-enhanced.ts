/**
 * Enhanced Session Modes - VEX 10/10 Transformation
 *
 * Makes session modes meaningfully different with:
 * - Mode-specific boss mechanics
 * - Unique reward tables per mode
 * - Distinct scoring rubrics
 * - Tactical trade-offs that matter
 *
 * @phase 1A - Core Loop Surgery
 */

import { SessionMode, SessionModeConfig, SESSION_MODE_CONFIG } from './modes';

// ============================================================================
// Enhanced Mode Configuration - Boss Mechanics
// ============================================================================

export type BossMechanicType =
  | 'REGENERATION'      // Boss heals if you pause (FLOW)
  | 'FOCUS_SHIELD'      // Requires uninterrupted time (CHALLENGE)
  | 'COUNTDOWN'         // Time pressure (RECOVERY)
  | 'IDEA_ORBS'         // Random bonus opportunities (CREATIVE)

export interface BossPhaseConfig {
  phaseThreshold: number; // 0-1, percent HP to trigger
  mechanic: BossMechanicType;
  intensity: number; // 0-1, how aggressive
  playerRisk: boolean; // Can player take damage/lose streak?
}

export interface ModeBossConfig {
  damageMultiplier: number;
  weakness: SessionMode | null; // Which mode deals bonus damage
  resistance: SessionMode | null; // Which mode deals reduced damage
  phases: BossPhaseConfig[];
  specialRewardType: string;
}

// ============================================================================
// Enhanced Mode Configuration - Reward Tables
// ============================================================================

export interface ModeRewardBias {
  primaryCurrency: 'COINS' | 'GEMS' | 'TOKENS';
  secondaryDrops: string[]; // Item category IDs
  rarityBoost: number; // 0-1, increased rare drop chance
  guaranteedDropAtStreak: number; // Streak days for guaranteed rare
}

// ============================================================================
// Enhanced Mode Configuration - Scoring Focus
// ============================================================================
...
// ============================================================================
// Enhanced Mode Configuration - Full Definition
// ============================================================================
...
// ============================================================================
// Enhanced Mode Configurations - VEX 10/10
// ============================================================================
...
// ============================================================================
// Mode Compatibility Matrix (for boss vulnerabilities)
// ============================================================================
