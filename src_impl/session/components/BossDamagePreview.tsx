/**
 * BossDamagePreview Component
 *
 * Small card in corner of active session showing boss info.
 * Displays boss name, current health, estimated damage this session.
 * Celebration animation when this session would defeat the boss.
 *
 * @phase 1C.5
 */
...
/**
 * Boss icon with celebration effect
 */
function BossIcon({
  willDefeat,
}: {
  ...
  return (
    <Animated.View style={animatedStyle}>
      <Box
        ...
        height={44}
        borderRadius="lg"
        bg={willDefeat ? `${theme.colors.success[500]}30` : theme.colors.background.tertiary}
        justifyContent="center"
        alignItems="center"
        borderWidth={willDefeat ? 2 : 1}
        borderColor={willDefeat ? theme.colors.success.DEFAULT : theme.colors.border.light}
      >
...
function BossHealthBar({
  ...
  const getHealthColor = () => {
    ...
    return theme.colors.error.DEFAULT; // Boss health is red (enemy)
  };
...
/**
 * Main boss damage preview component
 */
