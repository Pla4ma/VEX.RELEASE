 ...
 * Session Controls
 *
 * Control buttons for session operations.
 * Includes start, pause, resume, abandon actions.
 */
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              <Pressable
                ...
                accessibilityLabel="Continue Session button"
                accessibilityRole="button"
                accessibilityHint="Activates this control"
              >
              ...
              <Pressable
                ...
                accessibilityLabel="Yes, Abandon button"
                accessibilityRole="button"
                accessibilityHint="Activates this control"
              >
