...
export const EXPANSION_BOSSES: ExpansionBossTemplate[] = [
  {
    ...
    flavorText: ['"Just one more scroll..." it whispers, feeding on your fractured attention.', 'The Doomscroller grows fatter with every notification you check.', 'Your focus is its feast. Your discipline is its poison.'],
...

  {
    ...
    flavorText: ['The Burnout Beast feeds on isolated struggle. Together, you are stronger.', 'One warrior cannot defeat this beast. But a squad in sync? Unstoppable.', 'It whispers: "Rest alone." But you answer: "Rise together."'],
...

  {
    ...
    flavorText: ['Monday is its kingdom. Your motivation is its enemy.', '"Case of the Mondays?" No — case of the DEMONS.', 'It feeds on dread and Monday morning procrastination. Show it no mercy.'],
...

  {
    ...
    flavorText: ['Good enough? NEVER. The Perfectionist accepts only EXCELLENCE.', '"Aim for perfection" it demands. Show it your best.', 'Mediocrity bounces off its crystalline form. Only mastery matters.'],
...

  {
    ...
    flavorText: ['"Just one more video..." it hisses as midnight passes.', 'Sleep? Who needs sleep when there are distractions? it whispers.', 'The night is long, but your discipline is longer.'],
...

  {
    ...
    flavorText: ['"They\'re doing better than you..." it whispers. LIES.', 'Comparison is the thief of joy. This beast is the thief of focus.', 'Your only competition is who you were yesterday.'],
