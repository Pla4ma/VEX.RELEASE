...
export function validateBossDefeat(bossId: string, participants: { userId: string; damage: number; joinTime: number }[], defeatTime: number, bossStartTime: number): { valid: boolean; error?: string; contributionPercentages: Record<string, number> } {
