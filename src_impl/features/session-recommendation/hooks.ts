 ...
 */
export function useSessionRecommendation(input: Partial<SessionRecommendationInput>) {
...
export const sessionRecommendationKeys = {
  ...
  current: (userId: string) => [...sessionRecommendationKeys.all, 'current', userId] as const,
  analytics: (userId: string) => [...sessionRecommendationKeys.all, 'analytics', userId] as const,
};
