...
export function SessionStakesBriefing({ bossStake, streakStake, challengeStake, rivalStake, squadWarStake, onStakePress }: SessionStakesBriefingProps): JSX.Element {
  const { theme } = useTheme();
  ...
  const topStakes = stakes.sort((a, b) => a.priority - b.priority).slice(0, 3);
...
export * from "./SessionStakesBriefing.types";
