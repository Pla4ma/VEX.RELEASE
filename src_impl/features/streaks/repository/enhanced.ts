...
export async function batchUpdateStreaks(updates: Array<{ userId: string; streak: Partial<Streak> }>): Promise<{ successful: Streak[]; failed: Array<{ userId: string; error: StreaksRepositoryError }> }> {
