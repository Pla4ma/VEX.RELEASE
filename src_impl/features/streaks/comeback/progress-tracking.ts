...
export function checkQuestCompletion(
  ...
  // Check Quest 2 (30 minutes, A grade)
    ...
    const quest2Met = sessionDuration >= COMEBACK_QUEST_CONFIG.quest2.duration &&
  ...
  // Check Quest 3 (45 minutes, A grade)
    ...
    const quest3Met = sessionDuration >= COMEBACK_QUEST_CONFIG.quest3.duration &&
 ...
 */
export function calculateQuestProgress(quest: ComebackQuest): ComebackQuestProgress {
  ...
  return ComebackQuestProgressSchema.parse({
    ...
    rewards: {
      ...
      xpBonus: quest.allQuestsCompleted ? COMEBACK_QUEST_CONFIG.rewards.xpBonus : 0,
    },
  });
}
