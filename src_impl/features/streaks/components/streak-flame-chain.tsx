...
export const StreakFlameChain: React.FC<StreakFlameChainProps> = ({ currentStreak, longestStreak, isAtRisk, riskLevel, streakDays }) => {
  ...
  const renderDayNode = (day: (typeof streakDays)[0], index: number) => {
    ...
    return (
      <Animated.View key={day.date} style={[styles.dayNode, isCompleted && isAtRisk ? pulseStyle : undefined]}>
        <View
          style={[
            styles.dayCircle,
            isCompleted && {
