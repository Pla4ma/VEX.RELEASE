  ...
  describe("calculateStory", () => {
    ...
    it("should include progression cliffhanger when close to next tier", () => {
      const tierInput: GenerateStoryInput = {
        ...baseInput,
        progressionContext: {
          ...baseInput.progressionContext,
          sessionsToNextTier: 1,
        },
      };
    ...
    it("should handle short sessions", () => {
      const shortInput: GenerateStoryInput = {
        ...
        sessionSummary: {
          ...baseInput.sessionSummary,
          duration: 10 * 60 * 1000,
          effectiveDuration: 10 * 60 * 1000,
        },
      };

      const story = calculateStory(shortInput);
