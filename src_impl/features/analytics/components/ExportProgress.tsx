 ...
 * Displays export job status and progress
 */
...
export function ExportProgress({ job, onDownload, onCancel, onRetry }: ExportProgressProps) {
  ...
  return (
    <View style={[styles.container, { borderColor: status.color }]}>
      ...
      <View style={styles.actions}>
        {isActive && onCancel && (
          <Pressable style={({ pressed }) => [styles.button, styles.cancelButton, pressed && { opacity: 0.8 }]} onPress={onCancel} accessibilityRole="button" accessibilityLabel="Cancel button" accessibilityHint="Activates this control">
        ...
        {isComplete && onDownload && (
          <Pressable style={({ pressed }) => [styles.button, styles.downloadButton, pressed && { opacity: 0.8 }]} onPress={onDownload} accessibilityRole="button" accessibilityLabel="Download button" accessibilityHint="Activates this control">
            <Text style={styles.downloadButtonText}>Download</Text>
          </Pressable>
        )}

        {isFailed && onRetry && (
          <Pressable style={({ pressed }) => [styles.button, styles.retryButton, pressed && { opacity: 0.8 }]} onPress={onRetry} accessibilityRole="button" accessibilityLabel="Retry button" accessibilityHint="Activates this control">
