...
export async function fetchSessionHeatmapData(userId: string, weeks: number): Promise<SessionHeatmapData> {
...
export async function fetchFocusDNAMetrics(userId: string) {
