...
import { launchColors } from '@theme/tokens/launch-colors';
 const{width} = Dimensions.get('window'); interface WalletScreenProps{userId:string}type TransactionFilter='ALL'|CurrencyType|TransactionSource;interface BalanceCardProps{type:'COINS'|'GEMS'|'SEASONAL';amount:number;icon:string;color:string;subtitle?:string}function BalanceCard({type,amount,icon,color,subtitle}:BalanceCardProps){return<View style={[styles.balanceCard,{backgroundColor:color}]}>
      ...
      <View style={[styles.transactionIcon,{backgroundColor:isEarn ? launchColors.hex_10b98120 : launchColors.hex_ef444420}]}>
        <Text>{icon}</Text>
      </View>
      ...
      <View style={styles.balanceRow}>
        {[1,2].map(i=><View key={i}style={[styles.balanceCard,styles.skeleton,{backgroundColor:launchColors.hex_1e293b}]}>
  ...
  accessibilityHint="Activates this control">
      ...
      <ScrollView refreshControl={<RefreshControl refreshing={isRefreshing}onRefresh={handleRefresh}/>}>
        {}
        <View style={styles.balanceRow}>
          <BalanceCard type="COINS"amount={coins}icon="\uD83E\uDE99"color={launchColors.hex_f59e0b}subtitle={`Earned: ${wallet?.totalCoinsEarned.toLocaleString() ?? 0}`}/>
          <BalanceCard type="GEMS"amount={gems}icon="\uD83D\uDC8E"color={launchColors.hex_3b82f6}subtitle={`Earned: ${wallet?.totalGemsEarned.toLocaleString() ?? 0}`}/>
        </View>
  ...
  accessibilityHint="Activates this control">
    ...
    </View>;}const styles = createSheet({container:{flex:1,backgroundColor:launchColors.hex_1a1a2e},balanceRow:{flexDirection:'row',padding:16,gap:12},balanceCard:{flex:1,borderRadius:16,padding:16,alignItems:'center'},balanceIcon:{fontSize:32,marginBottom:8},balanceAmount:{color:launchColors.hex_fff,fontSize:24,fontWeight:'bold',marginBottom:4},balanceType:{color:launchColors.hex_fff,fontSize:12,textTransform:'uppercase',opacity:0.8},balanceSubtitle:{color:launchColors.hex_fff,fontSize:10,opacity:0.6,marginTop:4},seasonalSection:{paddingHorizontal:16,marginBottom:16},sectionTitle:{color:launchColors.hex_fff,fontSize:16,fontWeight:'bold',marginBottom:12},seasonalRow:{flexDirection:'row',flexWrap:'wrap',gap:8},seasonalCard:{backgroundColor:launchColors.hex_16213e,borderRadius:12,padding:12,minWidth:100,alignItems:'center'},seasonalAmount:{color:launchColors.hex_8b5cf6,fontSize:18,fontWeight:'bold'},seasonalName:{color:launchColors.hex_94a3b8,fontSize:10,marginTop:4,textTransform:'capitalize'},statsSection:{flexDirection:'row',paddingHorizontal:16,gap:8,marginBottom:16},statCard:{flex:1,backgroundColor:launchColors.hex_16213e,borderRadius:12,padding:12,alignItems:'center'},statValue:{color:launchColors.hex_fff,fontSize:16,fontWeight:'bold'},statLabel:{color:launchColors.hex_94a3b8,fontSize:10,marginTop:4},positive:{color:launchColors.hex_10b981},negative:{color:launchColors.hex_ef4444},filterBar:{maxHeight:50,marginBottom:8},filterContent:{paddingHorizontal:16,gap:8,alignItems:'center'},filterChip:{paddingHorizontal:16,paddingVertical:8,borderRadius:20,backgroundColor:launchColors.hex_16213e},filterChipActive:{backgroundColor:launchColors.hex_e94560},filterChipText:{color:launchColors.hex_94a3b8,fontSize:12,fontWeight:'500'},filterChipTextActive:{color:launchColors.hex_fff},transactionsHeader:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:16,paddingVertical:12},transactionCount:{color:launchColors.hex_94a3b8,fontSize:12},transactionsList:{paddingHorizontal:16},transactionItem:{flexDirection:'row',alignItems:'center',backgroundColor:launchColors.hex_16213e,borderRadius:12,padding:12,marginBottom:8},transactionIcon:{width:40,height:40,borderRadius:20,justifyContent:'center',alignItems:'center',marginRight:12},transactionInfo:{flex:1},transactionDescription:{color:launchColors.hex_fff,fontSize:14,fontWeight:'500',marginBottom:2},transactionSource:{color:launchColors.hex_94a3b8,fontSize:11,textTransform:'capitalize',marginBottom:2},transactionDate:{color:launchColors.hex_64748b,fontSize:10},transactionAmount:{alignItems:'flex-end'},amountText:{fontSize:16,fontWeight:'bold'},amountEarn:{color:launchColors.hex_10b981},amountSpend:{color:launchColors.hex_ef4444},currencyLabel:{color:launchColors.hex_64748b,fontSize:10,marginTop:2},emptyContainer:{alignItems:'center',paddingVertical:60},emptyIcon:{fontSize:64,marginBottom:16},emptyTitle:{color:launchColors.hex_fff,fontSize:18,fontWeight:'bold',marginBottom:8},emptySubtitle:{color:launchColors.hex_94a3b8,fontSize:14,textAlign:'center',marginBottom:24,paddingHorizontal:32},refreshButton:{paddingHorizontal:24,paddingVertical:12,backgroundColor:launchColors.hex_e94560,borderRadius:12},refreshButtonText:{color:launchColors.hex_fff,fontSize:16,fontWeight:'600'},errorContainer:{flex:1,justifyContent:'center',alignItems:'center',padding:24},errorIcon:{fontSize:64,marginBottom:16},errorTitle:{color:launchColors.hex_fff,fontSize:20,fontWeight:'bold',marginBottom:8},errorSubtitle:{color:launchColors.hex_94a3b8,fontSize:14,textAlign:'center',marginBottom:24},retryButton:{paddingHorizontal:24,paddingVertical:12,backgroundColor:launchColors.hex_e94560,borderRadius:12},retryButtonText:{color:launchColors.hex_fff,fontSize:16,fontWeight:'600'},skeleton:{backgroundColor:launchColors.hex_0f3460},skeletonText:{width:60,height:16,backgroundColor:launchColors.hex_1e293b,borderRadius:4},bottomSpacer:{height:40}});
