...
export function WagerWonCeremony({ amount, onComplete, autoDismiss = true, dismissDelay = 4000 }: WagerWonCeremonyProps): JSX.Element {
  ...
  useEffect(() => {
    ...
    coinScale.value = withSequence(withDelay(200, withSpring(1.5, { damping: 10 })), withSpring(1, { damping: 15 }));

    // Coin floating animation
    coinTranslateY.value = withRepeat(withSequence(withTiming(-10, { duration: 800 }), withTiming(10, { duration: 800 })), -1, true);
