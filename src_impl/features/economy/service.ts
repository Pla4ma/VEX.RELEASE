...
const economyServiceInstance: EconomyService = {
  ...
  addCurrency: async (_input: unknown) => ({
    newBalance: 0,
    earnedAmount: 0,
    transaction: {
  ...
  spendCurrency: async (_input: unknown) => ({
    success: false,
    newBalance: 0,
    transaction: null,
    error: {
  ...
  creditSessionRewards: async (_userId: unknown, _chestResult: unknown) => ({
    xpAdded: 0,
    coinsAdded: 0,
    gemsAdded: 0,
    bonusItemGranted: false,
  }),
  initiatePurchase: async (_input: unknown) => ({
    success: false,
    error: {
      code: 'SYSTEM_ERROR',
      message: 'Not implemented',
  ...
  processPurchasePayment: async (_input: unknown) => ({
    success: false,
    error: {
      code: 'SYSTEM_ERROR',
      message: 'Not implemented',
  ...
  completePurchaseDelivery: async (_input: unknown) => ({
    success: false,
    error: {
      code: 'SYSTEM_ERROR',
      message: 'Not implemented',
  ...
  requestRefund: async (_purchaseId: unknown, _userId: unknown, _reason: unknown) => ({
    id: '00000000-0000-0000-0000-000000000000',
  ...
  processRefund: async (_input: unknown) => ({
    id: '00000000-0000-0000-0000-000000000000',
    purchaseId: '00000000-0000-0000-0000-000000000000',
    userId: '00000000-0000-0000-0000-000000000000',
    reason: 'Stub refund request',
