...
export const ContentHistorySkeleton: React.FC = () => {
  ...
  return (
    <View style={[styles.list, { backgroundColor: theme.colors.background.primary }]}>
      {[1, 2, 3, 4, 5].map((i) => (
        <View key={i} style={[styles.listItem, { backgroundColor: theme.colors.background.secondary }]}>
...
export const ExtractionSkeleton: React.FC = () => {
  ...
  return (
    <View style={[styles.extractionCard, { backgroundColor: theme.colors.background.secondary }]}>
