...
interface OnboardingActions {
  ...
  /** Get draft for user (stub for compatibility) */
  getDraft: (userId: string) => { goal?: FocusGoal; focusDuration?: FocusDuration; displayName?: string; starterPresetId?: string; element?: string; personaId?: string; squadId?: string | null } | undefined;
  /** Save draft for user (stub for compatibility) */
  saveDraft: (userId: string, draft: { goal?: FocusGoal; focusDuration?: FocusDuration; displayName?: string; starterPresetId?: string; element?: string; personaId?: string; squadId?: string | null }) => void;
}
...
export const useOnboardingStore = create<OnboardingStore>()(
  persist(
    (set, get) => ({
      ...
      saveDraft: (_userId: string, draft: { goal?: FocusGoal; focusDuration?: FocusDuration; displayName?: string; starterPresetId?: string; element?: string; personaId?: string; squadId?: string | null }) => {
        if (draft.goal) {
