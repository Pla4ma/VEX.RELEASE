/**
 * NearMissDisplay Component
 *
 * When random roll is 0.10-0.15 (almost crit but not quite).
 * Subtle sparkle animation, slightly brighter than normal.
 * Psychological near-miss effect.
 *
 * @phase 3B.3
 */
 ...
 * Near miss display
 */
export function NearMissDisplay({
  xpAmount,
  onComplete,
}: NearMissDisplayProps): JSX.Element {
  ...
  const containerStyle = useAnimatedStyle(() => ({
    transform: [
      {
        scale: withSpring(1.05, { damping: 12, stiffness: 100 }),
      },
    ],
  }));
