...
export interface SessionRewardsClaimedEvent extends BaseSessionCompletionEvent {
  ...
  data: {
    ...
    multipliers: {
      active: DynamicValue[];
      applied: DynamicValue[];
      expired: DynamicValue[];
    };
    bonuses: {
      streak: DynamicValue;
      performance: DynamicValue;
      completion: DynamicValue;
      special: DynamicValue[];
    };
    inventory: {
      previous: DynamicValue;
      current: DynamicValue;
      overflow: DynamicValue;
    };
  };
}
...
export interface SessionPerformanceReportEvent extends BaseSessionCompletionEvent {
  ...
  data: {
    ...
    performance: {
      byType: DynamicRecord;
      byDifficulty: DynamicRecord;
      byTimeframe: DynamicRecord;
      byObjective: DynamicRecord;
    };
    trends: {
