...
export const SquadHub: React.FC<SquadHubProps> = ({ squadId, userId, onInvitePress, onSettingsPress, onMemberPress }) => {
        ...
        <Card style={styles.card}>
          ...
          <FlashList
            ...
            renderItem={({ item }: { item: SquadMemberDetail }) => (
              <Pressable style={({ pressed }) => [styles.onlineMemberItem, pressed && { opacity: 0.7 }]} onPress={() => onMemberPress?.(item)} accessibilityLabel="Interactive control" accessibilityRole="button" accessibilityHint="Activates this control">
