  ...
  useTheme: () => ({
    theme: {
      ...
      colors: {
        ...
        background: { secondary: 'theme.colors.primary[500]' },
        surface: { selected: 'theme.colors.primary[500]' },
        status: { error: 'theme.colors.primary[500]', warning: 'theme.colors.primary[500]', success: 'theme.colors.primary[500]', info: 'theme.colors.primary[500]' },
        text: { primary: 'theme.colors.background.primary', secondary: 'theme.colors.primary[500]' },
      },
    },
  }),
}));
