 ...
 */
export function countsForTodayStreak(sessionTimestamp: number, timezone: string): boolean {
 ...
 */
export function isStreakActive(lastSessionTimestamp: number, timezone: string): boolean {
 ...
 */
export function getHoursUntilStreakBreak(lastSessionTimestamp: number, timezone: string): number {
 ...
 */
export function scheduleForLocalTime(localHour: number, localMinute: number, timezone: string, targetDate?: Date): number {
  const now = new Date();
 ...
 */
export function formatRelativeTime(timestamp: number, timezone: string): string {
  const now = Date.now();
