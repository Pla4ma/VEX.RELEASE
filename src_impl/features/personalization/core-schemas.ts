...
export const PreferredToneSchema = z.enum(['soft', 'direct', 'warm', 'strategic']);
export const GamificationIntensitySchema = z.enum(['minimal', 'medium', 'strong']);
export const CoachModeSchema = z.enum(['mentor', 'tactical', 'study_tutor', 'reflection', 'game_guide']);
...
export const SessionModeSchema = z.enum(['FOCUS', 'STUDY', 'DEEP_WORK', 'SPRINT', 'CREATIVE', 'RECOVERY']);
