...
describe('computeFirstWeekExperience', () => {
  it('0-session user sees no advanced systems', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 0, daysSinceOnboarding: 0, daysSinceLastSession: null,
      motivationStyle: 'friendly', primaryGoal: 'focus',
      bossEngagement: 'none', studyUsageRatio: 0, isPremium: false,
  ...
  it('1-session user sees progress proof', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 1, daysSinceOnboarding: 1, daysSinceLastSession: 0,
      motivationStyle: 'friendly', primaryGoal: 'focus',
      bossEngagement: 'none', studyUsageRatio: 0, isPremium: false,
      featureAvailable: { boss: true, premium: true, social: false, study: true },
    });
  ...
  it('3-session user sees companion continuity', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 3, daysSinceOnboarding: 3, daysSinceLastSession: 0,
      motivationStyle: 'coach_led', primaryGoal: 'focus',
      bossEngagement: 'low', studyUsageRatio: 0.1, isPremium: false,
      featureAvailable: { boss: true, premium: true, social: false, study: true },
    });
  ...
  it('5-session user sees path forming, premium soft tease', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 5, daysSinceOnboarding: 5, daysSinceLastSession: 0,
      motivationStyle: 'study_focused', primaryGoal: 'study',
      bossEngagement: 'low', studyUsageRatio: 0.3, isPremium: false,
      featureAvailable: { boss: true, premium: true, social: false, study: true },
    });
  ...
  it('7-session user sees deeper mode', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 7, daysSinceOnboarding: 7, daysSinceLastSession: 0,
      motivationStyle: 'game_like', primaryGoal: 'personal_growth',
      bossEngagement: 'medium', studyUsageRatio: 0.2, isPremium: true,
      featureAvailable: { boss: true, premium: true, social: false, study: true },
    });
  ...
  it('comeback user sees recovery CTA', () => {
    const exp = computeFirstWeekExperience({
      completedSessions: 3, daysSinceOnboarding: 30, daysSinceLastSession: 5,
      motivationStyle: 'coach_led', primaryGoal: 'focus',
      bossEngagement: 'low', studyUsageRatio: 0.1, isPremium: false,
      featureAvailable: { boss: true, premium: true, social: false, study: true },
    });
