    ...
    SESSION_1: [
      {
        ...
        description: 'Your Focus Score now changes based on session quality and consistency.',
    ...
    SESSION_3: [
      {
        ...
        description: 'Your companion arrives, reflecting your first three focus sessions.',
        actionRequired: false,
        icon: '✨',
        priority: 1,
      },
    ...
    SESSION_4: [
      {
        ...
        description: 'VEX now recommends sessions based on your actual patterns.',
        actionRequired: false,
        icon: '💡',
        priority: 1,
      },
    ...
    SESSION_5: [
      {
        ...
        description: 'Your coach analyzes your focus patterns and shares a personal insight.',
        actionRequired: false,
        icon: '🧠',
        priority: 1,
      },
    ...
    SESSION_6: [
      {
        ...
        description: 'A small target based on your own history. Just your next step.',
        actionRequired: false,
        icon: '🎯',
        priority: 1,
      },
