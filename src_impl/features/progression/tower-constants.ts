...
export const TIER_CONFIG = [
  { tier: 1, name: 'Foundation', maxBlocks: 10, bonusType: 'XP_BOOST' as const, bonusPerBlock: 2, color: '#795548' },
  { tier: 2, name: 'Apprentice', maxBlocks: 10, bonusType: 'STREAK_RESISTANCE' as const, bonusPerBlock: 0.5, color: '#607D8B' },
  { tier: 3, name: 'Journeyman', maxBlocks: 10, bonusType: 'ENERGY_REGEN' as const, bonusPerBlock: 1, color: '#009688' },
  { tier: 4, name: 'Expert', maxBlocks: 10, bonusType: 'BOSS_DAMAGE' as const, bonusPerBlock: 3, color: '#3F51B5' },
  { tier: 5, name: 'Master', maxBlocks: 10, bonusType: 'FOCUS_DURATION' as const, bonusPerBlock: 5, color: '#9C27B0' },
  { tier: 6, name: 'Grandmaster', maxBlocks: 10, bonusType: 'XP_BOOST' as const, bonusPerBlock: 5, color: '#FF9800' },
  { tier: 7, name: 'Legend', maxBlocks: 20, bonusType: 'STREAK_RESISTANCE' as const, bonusPerBlock: 1, color: '#F44336' },
  { tier: 8, name: 'Mythic', maxBlocks: 50, bonusType: 'ENERGY_REGEN' as const, bonusPerBlock: 2, color: '#E91E63' },
];
