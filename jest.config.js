...
module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^expo-glass-effect$': '<rootDir>/src/__tests__/mocks/expo-glass-effect.ts',
    '^expo-mesh-gradient$': '<rootDir>/src/__tests__/mocks/expo-mesh-gradient.ts',
    '^expo-blur$': '<rootDir>/src/__tests__/mocks/expo-blur.ts',
