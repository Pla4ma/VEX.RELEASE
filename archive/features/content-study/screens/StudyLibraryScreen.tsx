            ...
            <Box flex={1} gap="xs">
              ...
              <Box flexDirection="row" alignItems="center" gap="sm">
                ...
                <Box
                  ...
                  borderRadius="sm"
                  style={{
                    backgroundColor: theme.colors[status.color as 'success' | 'error' | 'warning' | 'info']?.DEFAULT
                      ? `${theme.colors[status.color as 'success' | 'error' | 'warning' | 'info'].DEFAULT}15`
                      : `${theme.colors.info.DEFAULT}15`,
                  }}
                >
    ...
    if (error) {
      return (
        <Box alignItems="center" py="xl">
          ...
          <Button variant="outline" size="sm" mt="md" onPress={handleRefresh}
