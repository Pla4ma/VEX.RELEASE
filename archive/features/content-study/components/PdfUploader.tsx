        ...
        style={[
          styles.fileCard,
          {
            ...
            borderColor: isOversized
              ...
              : theme.colors.border?.DEFAULT || '#E2E8F0',
          },
        ]}
      >
        <View style={styles.fileInfo}>
          <Icon
            ...
            size="lg"
            color={isOversized ? theme.colors.error[500] : theme.colors.primary[500]}
          />
        ...
        <View style={styles.fileActions}>
          <Button variant="ghost" size="sm" onPress={removeFile}
      ...
      style={({ pressed }) => [
        styles.uploadContainer,
        {
          ...
          borderColor: isPicking
            ...
            : (theme.colors.border as any)?.DEFAULT || theme.colors.border,
      ...
      {isPicking ? (
        ...
        <>
          <Icon
            name="upload"
            size="xl"
            color={(theme.colors.primary as any)[500]}
            style={styles.uploadIcon}
          />
          <Text style={[styles.uploadTitle, { color: theme.colors.text.primary }]}>
            Tap to select a file
          </Text>
          <Text style={[styles.uploadSubtitle, { color: theme.colors.text.muted }]}>
